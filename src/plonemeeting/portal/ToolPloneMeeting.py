...
from plonemeeting.portal import logger
from plonemeeting.portal.config import ADD_CONTENT_PERMISSIONS
...
from plonemeeting.portal.config import PloneMeetingError
...
from plonemeeting.portal.content.content_category import ANNEX_NOT_KEPT
...
from plonemeeting.portal.model.adaptations import _performAdviceWorkflowAdaptations
from plonemeeting.portal.profiles import PloneMeetingConfiguration
from plonemeeting.portal.utils import configure_advice_dx_localroles_for
...
from plonemeeting.portal.utils import monthsIds
...
class ToolPloneMeeting(UniqueObject, OrderedFolder, BrowserDefaultMixin):
    ...
    def createMeetingConfigFolder(self, meetingConfigId, userId):
        ...
        # clean cache for "plonemeeting.portal.vocabularies.creatorsvocabulary"
        invalidate_cachekey_volatile_for("plonemeeting.portal.vocabularies.creatorsvocabulary")
        invalidate_cachekey_volatile_for("plonemeeting.portal.vocabularies.creatorsforfacetedfiltervocabulary")
    ...
    def getMeetingConfig(self, context):
        ...
        from plonemeeting.portal.interfaces import IMeetingConfig as IMC
        ...
        with api.env.adopt_roles(['Manager']):
            ...
            if not keepProposingGroup:
                ...
                if newItem.attribute_is_used('proposingGroupWithGroupInCharge'):
                    vocab = get_vocab(
                        newItem,
                        u'plonemeeting.portal.vocabularies.userproposinggroupswithgroupsinchargevocabulary',
                        only_factory=True)
                    ...
                    vocab = get_vocab(
                        newItem,
                        u'plonemeeting.portal.vocabularies.userproposinggroupsvocabulary',
    ...
    def convertAnnexes(self):
        ...
        brains = catalog.unrestrictedSearchResults(meta_type='MeetingItem') + \
            catalog.unrestrictedSearchResults(
                object_provides='plonemeeting.portal.content.advice.IMeetingAdvice')
        for brain in brains:
            obj = brain.getObject()
