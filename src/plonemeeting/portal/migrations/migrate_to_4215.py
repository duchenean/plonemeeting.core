...
class Migrate_To_4215(Migrator):
    ...
    def run(self, extra_omitted=[], from_migration_to_4200=False):
        ...
        if not from_migration_to_4200:
            ...
            load_type_from_package('ConfigurablePODTemplate', 'plonemeeting.portal:default')
            # hide document-generation-link default viewlet
            self.ps.runImportStepFromProfile('profile-plonemeeting.portal:default', 'viewlets')
        self._fixWSCConfig()
