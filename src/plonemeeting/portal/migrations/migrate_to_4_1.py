...
from plonemeeting.portal.content.person import PMPerson
from plonemeeting.portal.exportimport.content import update_labels_jar
...
class Migrate_To_4_1(Migrator):
    ...
    def _updateFacetedFilters(self):
        ...
        for cfg in self.tool.objectValues('MeetingConfig'):
            ...
            criteria.edit(
                'c12', **{
                    'vocabulary':
                        'plonemeeting.portal.vocabularies.creatorswithnobodyforfacetedfiltervocabulary'})
            criteria.edit(
                'c23', **{
        ...
        for brain in self.catalog(portal_type='person'):
            ...
            if not isinstance(person, PMPerson):
                ...
                migrate_base_class_to_new_class(
                    ...
                    new_class_name='plonemeeting.portal.content.person.PMPerson')
        logger.info('Done.')
    ...
    def run(self, extra_omitted=[]):
        ...
        # omit plonemeeting.portal for now or it creates infinite loop as we are
        # in a plonemeeting.portal upgrade step...
        ...
        self.reinstall(profiles=['profile-plonemeeting.portal:default', ],
        ...
        if self.profile_name != 'profile-plonemeeting.portal:default':
