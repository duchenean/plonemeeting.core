...
from plonemeeting.portal.browser.itemattendee import position_type_default
from plonemeeting.portal.config import AddAdvice
from plonemeeting.portal.content.advice import IMeetingAdvice
from plonemeeting.portal.content.meeting import IMeeting
from plonemeeting.portal.events import onHeldPositionWillBeRemoved
...
from plonemeeting.portal.migrations.migrate_to_4209 import Migrate_To_4209
from plonemeeting.portal.profiles import MeetingConfigDescriptor
from plonemeeting.portal.setuphandlers import columnInfos
from plonemeeting.portal.setuphandlers import indexInfos
...
class MeetingMigrator(CMFFolderMigrator):
    ...
    def migrate_schema_fields(self):
        ...
        if 'place' in self.used_meeting_attrs:
            ...
            vocab = get_vocab(
                self.new, "plonemeeting.portal.content.meeting.places_vocabulary")
...
class Migrate_To_4200(Migrator):
    ...
    def run(self, extra_omitted=[]):
        ...
        if self.is_in_part('a'):  # main step, everything but update local roles and refresh catalog
            ...
            self.runProfileSteps('plonemeeting.portal', steps=['workflow'], profile='default')
            # make sure new portal_type Meeting is installed
            self.removeUnusedPortalTypes(portal_types=['Meeting'])
            self.ps.runImportStepFromProfile('profile-plonemeeting.portal:default', 'typeinfo')
