...
class Migrator(BaseMigrator):
    ...
    def __init__(self, context):
        ...
        self.profile_name = u'profile-plonemeeting.portal:default'

    def reorderSkinsLayers(self):
        """Reapply skins of plonemeeting.portal + self.profile_name."""
        # re-apply the PloneMeeting skins and the self.profile_name skin if different
        self.runProfileSteps('plonemeeting.portal',
                             steps=['skins'],
                             profile='default')
        if self.profile_name != u'profile-plonemeeting.portal:default':
    ...
    def upgradeDependencies(self):
        ...
        profile_names = self.ps.getDependenciesForProfile(u'profile-plonemeeting.portal:default')
    ...
    def updateFacetedFilters(self, xml_filename=None, related_to="items", reorder=True, to_delete=[]):
        ...
        for cfg in self.tool.objectValues('MeetingConfig'):
            ...
            cleanRamCacheFor('plonemeeting.portal.adapters.compute_criteria')
