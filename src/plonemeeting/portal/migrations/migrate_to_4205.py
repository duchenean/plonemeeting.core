...
from plonemeeting.portal.setuphandlers import _configurePortalRepository
from plonemeeting.portal.utils import get_dx_data
...
class Migrate_To_4205(Migrator):
    ...
    def _updateConfigCommitteesAndVotesResult(self):
        ...
        self.runProfileSteps('plonemeeting.portal', steps=['rolemap', 'workflow'], profile='default')
