...
from plonemeeting.portal.MeetingConfig import defValues
...
class Migrate_To_4216(Migrator):
    ...
    def run(self, extra_omitted=[], from_migration_to_4200=False):
        ...
        load_type_from_package('annex', 'plonemeeting.portal:default')
        load_type_from_package('annexDecision', 'plonemeeting.portal:default')
