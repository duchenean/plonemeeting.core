...
from plonemeeting.portal.interfaces import IUtils
...
from plonemeeting.portal.config import HAS_RESTAPI
...
class PloneMeetingOverviewControlPanel(OverviewControlPanel):
    ...
    def version_overview(self):
        ...
        # PM
        pm_version = api.env.get_distribution('plonemeeting.portal')._version
        ps = api.portal.get_tool('portal_setup')
        pm_ps_version = ps.getVersionForProfile('plonemeeting.portal:default')
        pm_ps_last_version = u'.'.join(ps.getLastVersionForProfile('plonemeeting.portal:default'))
...
class PMRenderTermView(RenderTermPortletView):
    ...
    def number_of_items_cachekey(method, self, init=False):
        ...
        date = get_cachekey_volatile('plonemeeting.portal.MeetingItem.modified', method)
...
class PMUtils(BrowserView):
    ...
    def translate(self, vocab, value, widget=None):
        ...
        # XXX begin changes by plonemeeting.portal
        ...
        if IConfigElement.providedBy(self.context):
            ...
            value = ', '.join(nvalues)
        # XXX end changes by plonemeeting.portal
        return value
