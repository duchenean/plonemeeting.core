...
from plonemeeting.portal.content.advice import _advice_type_default
from plonemeeting.portal.ftw_labels.utils import filter_access_global_labels
from plonemeeting.portal.utils import _add_advice
from plonemeeting.portal.utils import displaying_available_items
from plonemeeting.portal.utils import is_operational_user
...
class MeetingStoreItemsPodTemplateAsAnnexBatchActionForm(BaseBatchActionForm):
    ...
    def _update(self):
        self.fields += Fields(schema.Choice(
            ...
            vocabulary='plonemeeting.portal.vocabularies.itemtemplatesstorableasannexvocabulary'))
...
class UpdateGroupsInChargeBatchActionForm(PMBaseARUOBatchActionForm):
    ...
    def _vocabulary(self):
        return 'plonemeeting.portal.vocabularies.itemgroupsinchargevocabulary'
...
class UpdateCopyGroupsBatchActionForm(PMBaseARUOBatchActionForm):
    ...
    def _vocabulary(self):
        return 'plonemeeting.portal.vocabularies.copygroupsvocabulary'
...
class UpdateCommitteesBatchActionForm(PMBaseARUOBatchActionForm):
    ...
    def _vocabulary(self):
        return 'plonemeeting.portal.vocabularies.item_selectable_committees_vocabulary'
...
class AddAdviceBatchActionForm(BaseBatchActionForm):
    ...
    def _advice_group_vocabulary(self):
        ...
        return get_vocab(
            self.context,
            'plonemeeting.portal.content.advice.advice_group_vocabulary',
...
class PMConcatenateAnnexesBatchActionForm(ConcatenateAnnexesBatchActionForm):
    ...
    def _annex_types_vocabulary(self):
        return "plonemeeting.portal.vocabularies.icon_item_annex_types_vocabulary"
