...
from plonemeeting.portal.browser.itemassembly import _itemsToUpdate
from plonemeeting.portal.browser.itemassembly import validate_apply_until_item_number
...
from plonemeeting.portal.interfaces import IRedirect
...
from plonemeeting.portal.utils import redirect
...
class IByeByeAttendee(IBaseAttendee):
    ...
    not_present_type = schema.Choice(
        ...
        description=_(u""),
        vocabulary=u"plonemeeting.portal.vocabularies.not_present_type_vocabulary",
        required=True)
...
class IRedefineSignatory(IBaseAttendee):
    ...
    signature_number = schema.Choice(
        ...
        required=True,
        vocabulary=u"plonemeeting.portal.vocabularies.numbersvocabulary")
