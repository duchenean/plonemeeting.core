...
def annex_ids_default(context):
    ...
    vocab = get_vocab(
        context,
        u"plonemeeting.portal.vocabularies.item_duplication_contained_annexes_vocabulary")
...
class IDuplicateItem(form.Schema):
    ...
    annex_ids = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u"plonemeeting.portal.vocabularies.item_duplication_contained_annexes_vocabulary"),
    )
    ...
    annex_decision_ids = schema.List(
        ...
        required=False,
        value_type=schema.Choice(
            vocabulary=u"plonemeeting.portal.vocabularies.item_duplication_contained_decision_annexes_vocabulary"),
    )
