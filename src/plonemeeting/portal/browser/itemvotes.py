...
from plonemeeting.portal.browser.itemattendee import BaseAttendeeForm
from plonemeeting.portal.browser.itemattendee import IBaseAttendee
...
from plonemeeting.portal.widgets.pm_number import PMNumberFieldWidget
from plonemeeting.portal.widgets.pm_selectreadonly import PMSelectReadonlyWidget
...
class DisplaySelectAllProvider(ContentProviderBase):
    ...
    def render(self):
        used_vote_terms = get_vocab(
            self.context, "plonemeeting.portal.vocabularies.usedvotevaluesvocabulary")
...
class IVote(Interface):
    ...
    voter_uid = schema.Choice(
        title=u'Voter UID',
        required=False,
        vocabulary="plonemeeting.portal.vocabularies.itemvotersvocabulary", )
    ...
    vote_value = schema.Choice(
        ...
        required=False,
        vocabulary="plonemeeting.portal.vocabularies.usedvotevaluesvocabulary", )
...
def secret_votes_default(context):
    ...
    used_vote_terms = get_vocab(
        context,
        "plonemeeting.portal.vocabularies.usedvotevaluesvocabulary",
        vote_number=vote_number)
