...
from plonemeeting.portal.config import product_globals
...
def initialize(context):
    ...
    from plonemeeting.portal import monkey  # noqa
    ...
    allow_module('plonemeeting.portal.safe_utils')
    allow_module('plonemeeting.portal.browser.meeting')
    allow_type(datetime)
