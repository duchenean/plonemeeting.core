...
from plonemeeting.portal.config import ALL_ADVISERS_GROUP_VALUE
...
from plonemeeting.portal.utils import findNewValue
...
from plonemeeting.portal.utils import getHistoryTexts
...
class ItemPrettyLinkAdapter(PrettyLinkAdapter):
    ...
    def getLink_cachekey(method, self):
        ...
        destMeetingConfigIds = get_vocab_values(
            self.context, 'plonemeeting.portal.vocabularies.other_mcs_clonable_to_vocabulary')
