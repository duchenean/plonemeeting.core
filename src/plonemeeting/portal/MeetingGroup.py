...
class MeetingGroup(BaseContent, BrowserDefaultMixin):
    ...
    def _invalidateCachedVocabularies(self):
        ...
        invalidate_cachekey_volatile_for("plonemeeting.portal.vocabularies.proposinggroupsvocabulary")
        invalidate_cachekey_volatile_for("plonemeeting.portal.vocabularies.proposinggroupacronymsvocabulary")
        invalidate_cachekey_volatile_for("plonemeeting.portal.vocabularies.proposinggroupsforfacetedfiltervocabulary")
        invalidate_cachekey_volatile_for("plonemeeting.portal.vocabularies.groupsinchargevocabulary")
        invalidate_cachekey_volatile_for("plonemeeting.portal.vocabularies.askedadvicesvocabulary")
