...
# from plonemeeting.portal.config import CKEDITOR_MENUSTYLES_CUSTOMIZED_MSG
from plonemeeting.portal.config import HAS_LDAP
from plonemeeting.portal.config import HAS_SOLR
# P6 migration: AMQP integration to be reimplemented in Stage D.
# from plonemeeting.portal.config import HAS_ZAMQP
from plonemeeting.portal.config import ManageOwnOrganizationFields
