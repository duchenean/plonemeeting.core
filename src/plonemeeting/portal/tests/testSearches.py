...
from plonemeeting.portal.adapters import _find_nothing_query
...
class testSearches(PloneMeetingTestCase):
    ...
    def test_pm_SearchItemsOfMyGroups(self):
        ...
        cleanRamCacheFor('plonemeeting.portal.adapters.query_itemsofmygroups')
        self.assertEqual(adapter.query,
    ...
    def test_pm_SearchItemsToAdviceAdapter(self):
        ...
        cleanRamCacheFor('plonemeeting.portal.adapters.query_itemstoadvice')
        self.assertEqual(
            adapter.query,
            {'indexAdvisers': {
    ...
    def test_pm_SearchAdvisedItems(self):
        ...
        cleanRamCacheFor('plonemeeting.portal.adapters.query_adviseditems')
        self.assertEqual(adapter.query,
    ...
    def test_pm_SearchAdvisedItemsWithDelay(self):
        ...
        # remove duplicates
        adviceStates = tuple(set(adviceStates))
        cleanRamCacheFor('plonemeeting.portal.adapters.query_adviseditemswithdelay')
        self.assertEqual(adapter.query,
                         {'indexAdvisers': {'query':
    ...
    def test_pm_SearchItemsInCopy(self):
        ...
        self.changeUser('pmCreator1')
        cleanRamCacheFor('plonemeeting.portal.adapters.query_itemsincopy')
        self.assertEqual(adapter.query,
                         {'getCopyGroups': {
    ...
    def test_pm_SearchItemsToValidateOfHighestHierarchicLevel(self):
        ...
        cleanRamCacheFor('plonemeeting.portal.adapters.query_itemstovalidateofhighesthierarchiclevel')
    ...
    def test_pm_SearchItemsToValidateOfMyReviewerGroups(self):
        ...
        cleanRamCacheFor('plonemeeting.portal.adapters.query_itemstovalidateofmyreviewergroups')
        query = adapter.query
    ...
    def test_pm_SearchItemsToValidateOfEveryReviewerLevelsAndLowerLevels(self):
        ...
        cleanRamCacheFor('plonemeeting.portal.adapters.query_itemstovalidateofeveryreviewerlevelsandlowerlevels')
    ...
    def test_pm_SearchItemsToCorrect(self):
        ...
        self.assertEqual(adapter.query, _find_nothing_query(itemTypeName))
        self.changeUser('pmManager')
        cleanRamCacheFor('plonemeeting.portal.adapters.query_itemstocorrect')
        self.assertEqual(
            adapter.query,
            {'portal_type': {'query': itemTypeName},
             'reviewProcessInfo': {
    ...
    def test_pm_SearchItemsToCorrectToValidateOfHighestHierarchicLevel(self):
        ...
        cleanRamCacheFor('plonemeeting.portal.adapters.query_itemstocorrecttovalidateofhighesthierarchiclevel')
        self.failIf(collection.results())
        self.do(developersItem, 'return_to_proposing_group')
        self.do(vendorsItem, 'return_to_proposing_group')
        ...
        self.assertTrue(self.hasPermission(ModifyPortalContent, developersItem))
        cleanRamCacheFor(
            'plonemeeting.portal.adapters.query_itemstocorrecttovalidateofhighesthierarchiclevel')
        res = collection.results()
        self.failUnless(len(res) == 1)
        self.failUnless(res[0].UID == developersItem.UID())
    ...
    def _test_reviewer_groups(self, developersItem, vendorsItem, collection):
        ...
        cleanRamCacheFor(
            'plonemeeting.portal.adapters.query_itemstocorrecttovalidateofeveryreviewerlevelsandlowerlevels')
    ...
    def test_pm_EverySearchesUseDifferentCachedMethod(self):
        """Make sure a different method is used for caching because every adapters
           ...
           plonemeeting.portal.adapters.query."""
        cfg = self.meetingConfig
