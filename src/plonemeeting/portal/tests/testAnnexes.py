...
from plonemeeting.portal.content.content_category import other_mc_correspondences_constraint
    ...
    def _checkElementConfidentialAnnexAccess(self,
        ...
        for snake_name, vocab_name in (
            ('item_annex_confidential_visible_for',
             'plonemeeting.portal.vocabularies.item_attribute_visible_for_vocabulary'),
            ('advice_annex_confidential_visible_for',
             'plonemeeting.portal.vocabularies.advice_annex_confidential_visible_for_vocabulary'),
            ('meeting_annex_confidential_visible_for',
             'plonemeeting.portal.vocabularies.meeting_annex_confidential_visible_for_vocabulary'),
        ):
