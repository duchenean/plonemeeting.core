...
class testFaceted(PloneMeetingTestCase):
    ...
    def test_pm_ItemCategoriesVocabulary(self):
        '''Test the "plonemeeting.portal.vocabularies.categoriesvocabulary"
        ...
        vocab = get_vocab(cfg,
                          "plonemeeting.portal.vocabularies.categoriesvocabulary",
                          only_factory=True)
    ...
    def test_pm_ItemClassifiersVocabulary(self):
        '''Test the "plonemeeting.portal.vocabularies.classifiersvocabulary"
        ...
        self._enableField('category')
        vocab = get_vocab(cfg,
                          "plonemeeting.portal.vocabularies.classifiersvocabulary",
                          only_factory=True)
        # once get, it is cached
        terms = vocab(pmFolder)
        # every existing categories are shown, no matter it is disabled
    ...
    def test_pm_ItemCategoriesVocabularyMCAware(self):
        '''Test that "plonemeeting.portal.vocabularies.categoriesvocabulary"
    ...
    def test_pm_MeetingDatesVocabulary(self):
        '''Test the "plonemeeting.portal.vocabularies.meetingdatesvocabulary"
           vocabulary, especially because it is cached.'''
        ...
        vocab = get_vocab(pmFolder,
                          "plonemeeting.portal.vocabularies.meetingdatesvocabulary",
                          only_factory=True)
        # once get, it is cached
        vocab(pmFolder)
        self.assertEqual(
    ...
    def test_pm_MeetingDatesVocabularyMCAware(self):
        '''Test that "plonemeeting.portal.vocabularies.meetingdatesvocabulary"
           vocabulary, is MeetingConfig aware, especially because it is cached.'''
        cfg = self.meetingConfig
        cfg2 = self.meetingConfig2
        self.changeUser('pmManager')
    ...
    def test_pm_ProposingGroupsVocabularies(self):
        ...
        vocab1 = get_vocab(
            pmFolder,
            "plonemeeting.portal.vocabularies.proposinggroupsvocabulary",
            only_factory=True)
        vocab2 = get_vocab(
            pmFolder,
        ...
        vocab3 = get_vocab(
            pmFolder,
            "plonemeeting.portal.vocabularies.proposinggroupsforfacetedfiltervocabulary",
            only_factory=True)
        vocab4 = get_vocab(
            pmFolder,
            "plonemeeting.portal.vocabularies.associatedgroupsvocabulary",
            only_factory=True)
        # once get, it is cached
    ...
    def test_pm_ProposingGroupsForFacetedVocabulary(self):
        '''Test that vocabulary "plonemeeting.portal.vocabularies.proposinggroupsforfacetedfiltervocabulary"
    ...
    def test_pm_GroupsInChargeVocabulary(self):
        '''Test the "plonemeeting.portal.vocabularies.groupsinchargevocabulary"
           vocabulary, especially because it is cached.'''
        cfg = self.meetingConfig
        self._enableField('category')
        ...
        vocab = get_vocab(org1,
                          "plonemeeting.portal.vocabularies.groupsinchargevocabulary",
                          only_factory=True)
    ...
    def test_pm_CreatorsVocabulary(self):
        '''Test the "plonemeeting.portal.vocabularies.creatorsvocabulary"
           vocabulary, especially because it is cached.'''
        self.changeUser('pmCreator1')
        pmFolder = self.getMeetingFolder()
        vocab = get_vocab(pmFolder,
                          "plonemeeting.portal.vocabularies.creatorsvocabulary",
                          only_factory=True)
        # once get, it is cached
    ...
    def test_pm_CreatorsForFacetedVocabulary(self):
        '''Test the "plonemeeting.portal.vocabularies.creatorsforfacetedvocabulary"
                   vocabulary, especially because it is cached.'''
        cfg = self.meetingConfig
        self.changeUser('pmCreator1')
        pmFolder = self.getMeetingFolder()
    ...
    def test_pm_AskedAdvicesVocabulary(self):
        '''Test the "plonemeeting.portal.vocabularies.askedadvicesvocabulary"
           vocabulary, especially because it is cached.'''
        self.changeUser('siteadmin')
        cfg = self.meetingConfig
        ...
        pmFolder = self.getMeetingFolder()
        vocab = get_vocab(pmFolder,
                          "plonemeeting.portal.vocabularies.askedadvicesvocabulary",
                          only_factory=True)
    ...
    def test_pm_AdviceTypesVocabulary(self):
        '''Test the "plonemeeting.portal.vocabularies.advicetypesvocabulary"
           vocabulary, especially because it is cached.'''
        cfg = self.meetingConfig
        self.changeUser('siteadmin')
        ...
        pmFolder = self.getMeetingFolder()
        vocab = get_vocab(pmFolder,
                          "plonemeeting.portal.vocabularies.advicetypesvocabulary",
                          only_factory=True)
        # once get, it is cached
    ...
    def test_pm_PMConditionAwareCollectionVocabulary(self):
        ...
        vocab_name = "plonemeeting.portal.vocabularies.conditionawarecollectionvocabulary"
    ...
    def test_pm_DisabledCollectionsAreIgnored(self):
        ...
        pmFolder = self.getMeetingFolder()
        vocab = get_vocab(pmFolder,
                          "plonemeeting.portal.vocabularies.conditionawarecollectionvocabulary",
                          only_factory=True)
    ...
    def test_pm_Faceted_annexes_vocabulary(self):
        ...
        vocab = get_vocab(
            cfg,
            "plonemeeting.portal.vocabularies.faceted_annexes_vocabulary",
            only_factory=True)
        self.changeUser('pmManager')
        item = self.create('MeetingItem')
    ...
    def test_pm_CopyGroupsVocabulary(self):
        ...
        self.changeUser('pmManager')
        self.assertEqual(
            get_vocab_values(cfg, "plonemeeting.portal.vocabularies.copygroupsvocabulary"),
