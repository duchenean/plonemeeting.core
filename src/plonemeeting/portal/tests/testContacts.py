...
from plonemeeting.portal.browser.itemattendee import _set_meeting_item_signatory
from plonemeeting.portal.browser.itemattendee import WRONG_PERSON_UID
from plonemeeting.portal.content.directory import IPMDirectory
from plonemeeting.portal.content.meeting import get_all_usable_held_positions
from plonemeeting.portal.content.meeting import IMeeting
from plonemeeting.portal.content.source import PMContactSourceBinder
...
class testContacts(PloneMeetingTestCase):
    ...
    def test_pm_DeactivatedOrgCanNoMoreBeUsed(self):
        ...
        advisers_vocab_factory = get_vocab(
            item,
            'plonemeeting.portal.vocabularies.itemoptionaladvicesvocabulary',
            only_factory=True)
    ...
    def test_pm_ImportContactsCSV(self):
        ...
        path = os.path.join(os.path.dirname(plonemeeting.portal.__file__), 'profiles/testing')
