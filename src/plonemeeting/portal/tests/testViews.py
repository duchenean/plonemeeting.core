...
# P6 migration: AMQP integration to be reimplemented in Stage D.
# from plonemeeting.portal.browser.views import SEVERAL_SAME_BARCODE_ERROR
...
from plonemeeting.portal.etags import ConfigModified
from plonemeeting.portal.etags import ContextModified
from plonemeeting.portal.etags import LinkedMeetingModified
from plonemeeting.portal.etags import ToolModified
...
from plonemeeting.portal.tests.PloneMeetingTestCase import DEFAULT_USER_PASSWORD
from plonemeeting.portal.tests.PloneMeetingTestCase import IMG_BASE64_DATA
from plonemeeting.portal.tests.PloneMeetingTestCase import PloneMeetingTestCase
from plonemeeting.portal.utils import extract_recipients
from plonemeeting.portal.utils import get_advice_alive_states
from plonemeeting.portal.utils import get_annexes
from plonemeeting.portal.utils import get_dx_widget
from plonemeeting.portal.utils import getAvailableMailingLists
...
class testViews(PloneMeetingTestCase):
    ...
    def test_pm_MeetingStoreItemsPodTemplateAsAnnexBatchActionForm_may_store(self):
        ...
        self.assertEqual(
            get_vocab_values(
                cfg, 'plonemeeting.portal.vocabularies.itemtemplatesstorableasannexvocabulary'),
            [])
    ...
    def test_pm_DocumentGenerationContext(self):
        ...
        from plonemeeting.portal import utils
        from plonemeeting.portal import safe_utils
