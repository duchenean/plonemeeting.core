...
from plonemeeting.portal.config import DEFAULT_USER_PASSWORD
...
from plonemeeting.portal.testing import PM_TESTING_PROFILE_FUNCTIONAL
from plonemeeting.portal.tests.helpers import PloneMeetingTestingHelpers
from plonemeeting.portal.utils import _add_advice
...
class PloneMeetingTestCase(unittest.TestCase, PloneMeetingTestingHelpers):
    ...
    def setUp(self):
        ...
        self.pmFolder = os.path.dirname(plonemeeting.portal.__file__)
    ...
    def create(self,
        ...
        if objectType == 'MeetingItem':
            if 'proposing_group' not in attrs.keys():
                cleanRamCacheFor('plonemeeting.portal.ToolPloneMeeting._get_org_uids_for_user')
    ...
    def _enableField(self, field_names, cfg=None, related_to='MeetingItem', enable=True, reload=False):
        ...
        if reload:
            ...
            cleanRamCacheFor('plonemeeting.portal.content.meeting.attribute_is_used')
