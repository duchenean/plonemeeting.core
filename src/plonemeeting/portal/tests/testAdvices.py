...
from plonemeeting.portal.indexes import indexAdvisers
...
from plonemeeting.portal.utils import isModifiedSinceLastVersion
...
class testAdvices(PloneMeetingTestCase):
    ...
    def test_pm_PowerAdvisers(self):
        ...
        factory = queryUtility(IVocabularyFactory, u'plonemeeting.portal.content.advice.advice_group_vocabulary')
        vocab = factory(item)
        self.assertEqual(len(vocab), 1)
    ...
    def test_pm_AvailableDelaysView(self):
        ...
        cleanRamCacheFor('plonemeeting.portal.content.meetingconfig._findLinkedRowsFor')
    ...
    def test_pm_ChangeAdviceAskedAgainView(self):
        ...
        factory = queryUtility(
            IVocabularyFactory,
            u'plonemeeting.portal.content.advice.advice_type_vocabulary')
    ...
    def test_pm_AdviceAccountingCommitmentBehavior(self):
        ...
        behaviors += ('plonemeeting.portal.behaviors.advice.IAdviceAccountingCommitmentBehavior', )
