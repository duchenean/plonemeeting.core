...
from plonemeeting.portal.model.adaptations import RETURN_TO_PROPOSING_GROUP_FROM_ITEM_STATES
...
class testWFAdaptations(PloneMeetingTestCase):
    ...
    def test_pm_WFA_decide_item_when_back_to_meeting_from_returned_to_proposing_group(self):
        ...
        from plonemeeting.portal.config import ITEM_TRANSITION_WHEN_RETURNED_FROM_PROPOSING_GROUP_AFTER_CORRECTION
