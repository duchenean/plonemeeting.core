...
from plonemeeting.portal.events import _itemAnnexTypes
...
class testMeetingConfig(PloneMeetingTestCase):
    ...
    def test_pm_MeetingManagersMayEditHarmlessConfigFields(self):
        ...
        from plonemeeting.portal.content.meetingconfig import IMeetingConfig as IMeetingConfigDX
    ...
    def test_pm_ConfigModifiedWhenFTWLabelManaged(self):
        """MeetingConfig is modified when a label is added/updated/removed.
           As the 'plonemeeting.portal.vocabularies.ftwlabelsforfacetedfiltervocabulary'
        ...
        vocab_factory = get_vocab(
            pmFolder,
            'plonemeeting.portal.vocabularies.ftwlabelsforfacetedfiltervocabulary',
            only_factory=True)
        # add a label
    ...
    def test_pm_Validate_itemWFValidationLevels_removed_depending_used_state_item(self):
        ...
        from plonemeeting.portal.model import adaptations
    ...
    def test_pm_VocabulariesNoValueContext(self):
        ...
        from plonemeeting.portal.vocabularies import AdviceWorkflowAdaptationsVocabularyFactory
        from plonemeeting.portal.vocabularies import ItemFieldsConfigVocabularyFactory
        from plonemeeting.portal.vocabularies import WorkflowAdaptationsVocabularyFactory
        cfg = self.meetingConfig
