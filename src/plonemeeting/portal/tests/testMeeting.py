...
from plonemeeting.portal.adapters import CAN_NOT_DELETE_MEETING_ERROR
...
from plonemeeting.portal.content.meeting import assembly_constraint
from plonemeeting.portal.content.meeting import default_committees
from plonemeeting.portal.content.meeting import IMeeting
from plonemeeting.portal.content.meeting import PLACE_OTHER
...
from plonemeeting.portal.tests.PloneMeetingTestCase import DefaultData
...
class testMeetingType(PloneMeetingTestCase):
    ...
    def test_pm_InsertItemOnListTypes(self):
        ...
        self.assertEqual(normalItem2.list_type, 'normal')
        self.assertEqual([item.list_type for item in orderedItems],
                         ['normal', 'normal', 'normal', 'late', 'addendum',
    ...
    def test_pm_InsertItemOnProposingGroupsWithDisabledGroup(self):
        ...
        newItem.decision = richtextval('<p>Default decision</p>')
    ...
    def test_pm_InsertItemOnAllGroupsWithDisabledGroup(self):
        ...
        newItem.setProposingGroup(self.vendors_uid)
        newItem.decision = richtextval('<p>Default decision</p>')
        newItem.associated_groups = (self.endUsers_uid, )
        ...
        secondItem.decision = richtextval('<p>Default decision</p>')
        secondItem.associated_groups = (self.vendors_uid, )
    ...
    def test_pm_InsertItemOnAllCommittees(self):
        ...
        orderedItems = meeting.get_items(ordered=True)
        self.assertEqual(
            [item.committees for item in orderedItems],
            [(),
             (),
             (),
             ('committee_1',),
    ...
    def test_pm_InsertItemOnPrivacyThenProposingGroups(self):
        ...
        self.assertEqual([item.privacy for item in meeting.get_items(ordered=True)],
    ...
    def test_pm_InsertItemOnPrivacyUsingHeading(self):
        ...
        self.assertEqual([item.privacy for item in meeting2.get_items(ordered=True)],
    ...
    def test_pm_InsertItemOnPollType(self):
        ...
        cfg.setInsertingMethodsOnAddItem(({'insertingMethod': 'on_poll_type',
                                           'reverse': '0'}, ))
        meeting = self._createMeetingWithItems()
        self.assertEqual([item.poll_type for item in meeting.get_items(ordered=True)],
    ...
    def test_pm_InsertItemOnPrivacyThenProposingGroupsWithDisabledGroup(self):
        ...
        self.presentItem(newItem)
        self.assertEqual(newItem.getId(), 'o2')
        self.assertEqual(newItem.privacy, 'public')
    ...
    def test_pm_InsertItemOnPrivacyThenCategories(self):
        ...
        self.meetingConfig.setInsertingMethodsOnAddItem(({'insertingMethod': 'on_privacy',
                                                         ...
                                                         {'insertingMethod': 'on_categories',
                                                          'reverse': '0'},))
        meeting = self._createMeetingWithItems()
        self.assertEqual([(item.privacy, item.getCategory()) for item in meeting.get_items(ordered=True)],
                         [('public', 'development'),
                          ('public', 'events'),
                          ('public', 'research'),
                          ('secret', 'development'),
    ...
    def test_pm_InsertItemOnPrivacyThenCategoriesWithDisabledCategory(self):
        ...
        self.assertEqual([(item.getId(), item.privacy, item.getCategory())
                          for item in meeting.get_items(ordered=True)],
    ...
    def test_pm_InsertItemOnToDiscuss(self):
        ...
        self.assertEqual([anItem.to_discuss for anItem in meeting.get_items(ordered=True)],
        ...
        self.assertEqual([item.to_discuss for item in meeting.get_items(ordered=True)],
    ...
    def test_pm_InsertItemInToDiscussThenProposingGroup(self):
        ...
        self.assertEqual([(anItem.to_discuss, anItem.getProposingGroup()) for
                          anItem in meeting.get_items(ordered=True)],
    ...
    def test_pm_InsertItemOnToOtherMCToCloneTo(self):
        ...
        self.assertEqual([anItem.other_meeting_configs_clonable_to for
                          anItem in meeting.get_items(ordered=True)],
    ...
    def test_pm_InsertItemOnCategoriesThenOnToOtherMCToCloneTo(self):
        ...
        self.assertEqual([(anItem.getCategory(), anItem.other_meeting_configs_clonable_to) for
                          anItem in meeting.get_items(ordered=True)],
                         [('deployment', (cfg1Id, )),
                          ('deployment', (cfg1Id, )),
                          ('deployment', (cfg1Id, )),
    ...
    def test_pm_GetItemInsertOrderByOrderedAssociatedOrganizations(self):
        ...
        # editing an item invalidates cache
        item.associated_groups = (self.vendors_uid, )
        item._update_after_edit()
    ...
    def test_pm_NormalAndLateItem(self):
        ...
        self.presentItem(normalItem)
        self.assertEqual(normalItem.list_type, 'normal')

        # freeze the meeting and insert the late item
        self.freezeMeeting(meeting)
        self.assertTrue(meeting.is_late())
        self.presentItem(lateItem)
        self.assertEqual(lateItem.list_type, 'late')
        ...
        self.assertFalse(meeting.is_late())
        self.presentItem(lateItem)
        self.assertEqual(lateItem.list_type, 'normal')
    ...
    def test_pm_MeetingNumbers(self):
        ...
        self.assertEqual(cfg.last_meeting_number, 0)
        ...
        self.publishMeeting(m1)
        self.assertEqual(m1.meeting_number, 1)
        self.assertEqual(cfg.last_meeting_number, 1)
        ...
        self.assertEqual(cfg.last_meeting_number, 3)
    ...
    def _checkAvailableItems(self):
        ...
        if 'category' in cfg.used_item_attributes:
    ...
    def test_pm_PresentItemWhenNoPublishedMeeting(self):
        ...
        self.assertFalse(cfg.meeting_present_item_when_no_current_meeting_states)
    ...
    def test_pm_RemoveWholeMeeting(self):
        ...
        anItem.optional_advisers = (self.vendors_uid,)
    ...
    def test_pm_MeetingAddEditAndView(self):
        ...
        attrs = [attr for attr in get_vocab_values(
                     cfg, 'plonemeeting.portal.vocabularies.used_meeting_attributes_vocabulary')
    ...
    def test_pm_Get_committee_items(self):
        ...
        suppl_item2.committees = ("committee_2__suppl__2", )
    ...
    def test_pm_DeadlineFieldsInit(self):
        ...
        # 5 days before, 9h30
        self.assertEqual(cfg.validation_deadline_default, '5.9:30')
        # 1 day before, 14h30
        self.assertEqual(cfg.freeze_deadline_default, '1.14:30')
        self.changeUser("pmManager")
