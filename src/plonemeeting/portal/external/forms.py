...
from plonemeeting.portal.external.utils import send_vision_json_request
...
class ILinkWithVision(Interface):
    ...
    projects = schema.List(
        ...
        value_type=schema.Choice(
          vocabulary=u'plonemeeting.portal.external.vocabularies.visionprojects'),
    )
    ...
    tasks = schema.List(
        ...
        value_type=schema.Choice(
          vocabulary=u'plonemeeting.portal.external.vocabularies.visiontasks'),
    )
