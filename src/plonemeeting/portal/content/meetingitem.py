...
field set defined in ``plonemeeting/portal/MeetingItem.py``. Every AT
...
The AT class in ``plonemeeting/portal/MeetingItem.py`` remains the
...
from plonemeeting.portal.browser.itemvotes import next_vote_is_linked
from plonemeeting.portal.config import AddAdvice
from plonemeeting.portal.config import AUTO_COPY_GROUP_PREFIX
from plonemeeting.portal.config import BUDGETIMPACTEDITORS_GROUP_SUFFIX
from plonemeeting.portal.config import CONFIGURABLE_FIELD_NAMES
from plonemeeting.portal.config import CONSIDERED_NOT_GIVEN_ADVICE_VALUE
...
from plonemeeting.portal.config import DUPLICATE_EVENT_ACTION
...
from plonemeeting.portal.config import HIDDEN_DURING_REDACTION_ADVICE_VALUE
from plonemeeting.portal.config import HIDE_DECISION_UNDER_WRITING_MSG
from plonemeeting.portal.config import INSERTING_ON_ITEM_DECISION_FIRST_WORDS_NB
from plonemeeting.portal.config import ITEM_COMPLETENESS_ASKERS
from plonemeeting.portal.config import ITEM_COMPLETENESS_EVALUATORS
from plonemeeting.portal.config import ITEM_LABELS_ACCESS_CACHE_ATTR
...
from plonemeeting.portal.config import NOT_GIVEN_ADVICE_VALUE
from plonemeeting.portal.config import NOT_VOTABLE_LINKED_TO_VALUE
from plonemeeting.portal.config import PMMessageFactory as _
from plonemeeting.portal.config import ReadBudgetInfos
from plonemeeting.portal.config import READER_USECASES
from plonemeeting.portal.config import REINDEX_NEEDED_MARKER
...
from plonemeeting.portal.config import WriteCommitteeFields
from plonemeeting.portal.config import WriteDecision
from plonemeeting.portal.config import WriteInternalNotes
from plonemeeting.portal.config import WriteItemMeetingManagerFields
from plonemeeting.portal.config import WriteMarginalNotes
from plonemeeting.portal.content.meeting import Meeting
from plonemeeting.portal.events import item_added_or_initialized
from plonemeeting.portal.ftw_labels.utils import compute_labels_access
from plonemeeting.portal.ftw_labels.utils import get_labels
from plonemeeting.portal.interfaces import IMeetingItem as IMeetingItemMarker
from plonemeeting.portal.model.adaptations import get_waiting_advices_infos
from plonemeeting.portal.model.adaptations import RETURN_TO_PROPOSING_GROUP_MAPPINGS
from plonemeeting.portal.utils import _addManagedPermissions
from plonemeeting.portal.utils import _base_extra_expr_ctx
from plonemeeting.portal.utils import _clear_local_roles
from plonemeeting.portal.utils import _get_category
from plonemeeting.portal.utils import _storedItemNumber_to_itemNumber
from plonemeeting.portal.utils import addDataChange
from plonemeeting.portal.utils import AdvicesUpdatedEvent
from plonemeeting.portal.utils import checkMayQuickEdit
from plonemeeting.portal.utils import cleanMemoize
from plonemeeting.portal.utils import compute_item_roles_to_assign_to_suffixes
from plonemeeting.portal.utils import decodeDelayAwareId
...
from plonemeeting.portal.utils import forceHTMLContentTypeForEmptyRichFields
from plonemeeting.portal.utils import get_internal_number
from plonemeeting.portal.utils import get_dx_schema
from plonemeeting.portal.utils import get_states_before
...
from plonemeeting.portal.utils import getWorkflowAdapter
from plonemeeting.portal.utils import hasHistory
from plonemeeting.portal.utils import is_editing
...
from plonemeeting.portal.utils import ItemDuplicatedEvent
from plonemeeting.portal.utils import ItemDuplicatedToOtherMCEvent
from plonemeeting.portal.utils import ItemLocalRolesUpdatedEvent
from plonemeeting.portal.utils import meetingExecuteActionOnLinkedItems
from plonemeeting.portal.utils import networkdays
from plonemeeting.portal.utils import normalize
from plonemeeting.portal.utils import normalize_id
from plonemeeting.portal.utils import notifyModifiedAndReindex
from plonemeeting.portal.utils import reindex_object
from plonemeeting.portal.utils import rememberPreviousData
from plonemeeting.portal.utils import sendMail
from plonemeeting.portal.utils import sendMailIfRelevant
from plonemeeting.portal.utils import set_field_from_ajax
from plonemeeting.portal.utils import set_internal_number
from plonemeeting.portal.utils import transformAllRichTextFields
from plonemeeting.portal.utils import translate_list
from plonemeeting.portal.utils import updateAnnexesAccess
from plonemeeting.portal.utils import validate_item_assembly_value
from plonemeeting.portal.utils import workday
from plonemeeting.portal.widgets.pm_textarea import render_textarea
...
class IMeetingItem(IMeetingItemMarker):
    ...
    proposing_group = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.userproposinggroupsvocabulary',
        required=False,
    )
    ...
    proposing_group_with_group_in_charge = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.userproposinggroupswithgroupsinchargevocabulary',
        required=False,
    )
    ...
    groups_in_charge = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.itemgroupsinchargevocabulary'),
        required=False,
        default=[],
    )
    ...
    associated_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.itemassociatedgroupsvocabulary'),
        required=False,
        default=[],
    )
    ...
    category = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.categoriesvocabulary',
        required=False,
    )
    ...
    classifier = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.classifiersvocabulary',
        required=False,
    )
    ...
    committees = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_selectable_committees_vocabulary'),
        required=True,
        default=[],
    )
    ...
    list_type = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.listtypesvocabulary',
        required=False,
        default=u'normal',
    )
    ...
    emergency = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.item_emergencies_vocabulary',
        required=False,
    ...
    preferred_meeting = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.item_meetings_accepting_items_vocabulary',
        required=False,
    ...
    item_tags = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_tags_vocabulary'),
        required=False,
        default=[],
    )
    ...
    optional_advisers = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.itemoptionaladvicesvocabulary'),
        required=False,
        default=[],
    )
    ...
    item_initiator = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_initiators_vocabulary'),
        required=False,
        default=[],
    )
    ...
    meeting_transition_inserting_me = schema.Choice(
        ...
        description=_(u'meeting_transition_inserting_me_descr',
                      default=u'Meetingtransitioninsertingme'),
        vocabulary=u'plonemeeting.portal.vocabularies.item_meeting_transitions_vocabulary',
        required=False,
    )
    ...
    copy_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.itemcopygroupsvocabulary'),
        required=False,
        default=[],
    )
    ...
    restricted_copy_groups = schema.List(
        ...
        description=_(u'descr_field_vieawable_by_everyone', default=u''),
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.itemrestrictedcopygroupsvocabulary'),
        required=False,
        default=[],
    )
    ...
    poll_type = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.polltypesvocabulary',
        required=False,
        default=u'freehand',
    )
    ...
    other_meeting_configs_clonable_to = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.other_mcs_clonable_to_vocabulary'),
        required=False,
        default=[],
    )
    ...
    other_meeting_configs_clonable_to_emergency = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.'
    ...
    privacy = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.privaciesvocabulary',
        required=False,
        default=u'public',
    )
    ...
    completeness = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.item_completeness_vocabulary',
        required=False,
...
class MeetingItem(Container):
    ...
    the AT module ``plonemeeting/portal/MeetingItem.py`` still exists
            ...
            for removedAdviser in removedAdvisers:
                ...
                if removedAdviser in givenAdvices and \
                   givenAdvices[removedAdviser]['optional'] is True:
                    vocab = get_vocab(self, u'plonemeeting.portal.vocabularies.itemoptionaladvicesvocabulary')
    ...
    def getMeetingToInsertIntoWhenNoCurrentMeetingObjectPath_cachekey(method, self):
        ...
        date_date = get_cachekey_volatile('plonemeeting.portal.Meeting.date')
        date_review_state = get_cachekey_volatile('plonemeeting.portal.Meeting.review_state')
        tool = api.portal.get_tool('portal_plonemeeting')
        cfg = tool.getMeetingConfig(self)
    ...
    def mayQuickEdit(self,
        ...
        from plone.autoform.interfaces import WRITE_PERMISSIONS_KEY
        from plone.supermodel.utils import mergedTaggedValueDict
        from plonemeeting.portal.content.meetingconfig import _camel_to_snake
    ...
    def _findOrderFor(self, insertMethod):
        ...
        if insertMethod == 'on_list_type':
            ...
            values = get_vocab_values(
                self,
                'plonemeeting.portal.vocabularies.other_mcs_clonable_to_vocabulary')
            if not toCloneTo:
                res = len(values) + 1
            else:
            ...
            factory = queryUtility(IVocabularyFactory,
                                   'plonemeeting.portal.vocabularies.polltypesvocabulary')
    ...
    def displayOtherMeetingConfigsClonableTo(self):
        ...
        tool = api.portal.get_tool('portal_plonemeeting')
        vocab = get_vocab(self, 'plonemeeting.portal.vocabularies.other_mcs_clonable_to_vocabulary')
    ...
    def displayCopyGroups(self, restricted=False):
        ...
        portal_url = api.portal.get().absolute_url()
        vocab_name = (
            u'plonemeeting.portal.vocabularies.itemrestrictedcopygroupsvocabulary'
            if restricted else
