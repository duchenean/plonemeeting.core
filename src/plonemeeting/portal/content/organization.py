...
from plonemeeting.portal.events import _invalidateOrgRelatedCachedVocabularies
from plonemeeting.portal.utils import computeCertifiedSignatures
from plonemeeting.portal.utils import listifySignatures
from plonemeeting.portal.validators import DXCertifiedSignaturesValidator
...
class ICertifiedSignaturesRowSchema(Interface):
    ...
    signature_number = schema.Choice(
        ...
        vocabulary='plonemeeting.portal.vocabularies.numbersvocabulary',
        required=True,
    )
    ...
    held_position = schema.Choice(
        ...
        vocabulary='plonemeeting.portal.vocabularies.every_heldpositions_vocabulary',
        required=False,
    )
...
class IPMOrganization(IOrganization):
    ...
    item_advice_states = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary="plonemeeting.portal.vocabularies.itemallstates"),
        required=False,
        default=[],
    )
