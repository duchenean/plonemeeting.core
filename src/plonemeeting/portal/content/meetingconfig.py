...
from plonemeeting.portal.compat import DisplayList
from plonemeeting.portal.compat import IntDisplayList
...
from plonemeeting.portal.config import ADVICE_TYPES
from plonemeeting.portal.config import BUDGETIMPACTEDITORS_GROUP_SUFFIX
from plonemeeting.portal.config import CLONE_TO_OTHER_MC_ACTION_SUFFIX
from plonemeeting.portal.config import CLONE_TO_OTHER_MC_EMERGENCY_ACTION_SUFFIX
from plonemeeting.portal.config import DEFAULT_ITEM_COLUMNS
from plonemeeting.portal.config import DEFAULT_LIST_TYPES
from plonemeeting.portal.config import DEFAULT_MEETING_COLUMNS
from plonemeeting.portal.config import EXECUTE_EXPR_VALUE
from plonemeeting.portal.config import ITEM_DEFAULT_TEMPLATE_ID
from plonemeeting.portal.config import ITEM_ICON_COLORS
from plonemeeting.portal.config import ITEM_INSERT_METHODS
from plonemeeting.portal.config import ITEMTEMPLATESMANAGERS_GROUP_SUFFIX
from plonemeeting.portal.config import ManageItemCategoryFields
from plonemeeting.portal.config import MEETING_REMOVE_MOG_WFA
from plonemeeting.portal.config import MEETINGMANAGERS_GROUP_SUFFIX
from plonemeeting.portal.config import NO_TRIGGER_WF_TRANSITION_UNTIL
from plonemeeting.portal.config import NOT_ENCODED_VOTE_VALUE
from plonemeeting.portal.config import PMMessageFactory as _
from plonemeeting.portal.config import READER_USECASES
from plonemeeting.portal.config import TOOL_FOLDER_ANNEX_TYPES
from plonemeeting.portal.config import TOOL_FOLDER_CATEGORIES
from plonemeeting.portal.config import TOOL_FOLDER_CLASSIFIERS
from plonemeeting.portal.config import TOOL_FOLDER_ITEM_TEMPLATES
from plonemeeting.portal.config import TOOL_FOLDER_MEETING_CATEGORIES
from plonemeeting.portal.config import TOOL_FOLDER_POD_TEMPLATES
from plonemeeting.portal.config import TOOL_FOLDER_RECURRING_ITEMS
from plonemeeting.portal.config import TOOL_FOLDER_SEARCHES
from plonemeeting.portal.config import WriteBudgetInfos
from plonemeeting.portal.config import WriteHarmlessConfig
from plonemeeting.portal.config import WriteRiskyConfig
from plonemeeting.portal.interfaces import IConfigElement
from plonemeeting.portal.interfaces import IMeetingAdviceWorkflowActions
from plonemeeting.portal.interfaces import IMeetingConfig as IMeetingConfigMarker
from plonemeeting.portal.interfaces import IMeetingAdviceWorkflowConditions
from plonemeeting.portal.interfaces import IMeetingDashboardBatchActionsMarker
from plonemeeting.portal.interfaces import IMeetingItem
from plonemeeting.portal.interfaces import IMeetingItemDashboardBatchActionsMarker
from plonemeeting.portal.interfaces import IMeetingItemWorkflowActions
from plonemeeting.portal.interfaces import IMeetingItemWorkflowConditions
from plonemeeting.portal.interfaces import IMeetingWorkflowActions
from plonemeeting.portal.interfaces import IMeetingWorkflowConditions
from plonemeeting.portal.indexes import DELAYAWARE_ROW_ID_PATTERN
from plonemeeting.portal.indexes import REAL_ORG_UID_PATTERN
from plonemeeting.portal.MeetingConfig import CONFIGGROUPPREFIX
from plonemeeting.portal.MeetingConfig import DUPLICATE_SHORT_NAME
from plonemeeting.portal.MeetingConfig import ITEM_WF_STATE_ATTRS
from plonemeeting.portal.MeetingConfig import ITEM_WF_TRANSITION_ATTRS
from plonemeeting.portal.MeetingConfig import MEETING_WF_STATE_ATTRS
from plonemeeting.portal.MeetingConfig import MEETING_WF_TRANSITION_ATTRS
from plonemeeting.portal.MeetingConfig import POWEROBSERVERPREFIX
from plonemeeting.portal.MeetingConfig import PROPOSINGGROUPPREFIX
from plonemeeting.portal.MeetingConfig import READERPREFIX
from plonemeeting.portal.MeetingConfig import SUFFIXPROFILEPREFIX
from plonemeeting.portal.content.meeting import Meeting
from plonemeeting.portal.content.meetingitem import IMeetingItem
from plonemeeting.portal.model.adaptations import _getValidationReturnedStates
from plonemeeting.portal.model.adaptations import _performWorkflowAdaptations
from plonemeeting.portal.profiles import MeetingConfigDescriptor
from plonemeeting.portal.utils import _base_extra_expr_ctx
from plonemeeting.portal.utils import computeCertifiedSignatures
from plonemeeting.portal.utils import createOrUpdatePloneGroup
from plonemeeting.portal.utils import duplicate_workflow
from plonemeeting.portal.utils import get_annexes
from plonemeeting.portal.utils import get_datagridfield_column_value
from plonemeeting.portal.utils import get_dx_attrs
from plonemeeting.portal.utils import get_dx_schema
from plonemeeting.portal.utils import get_item_validation_wf_suffixes
from plonemeeting.portal.utils import getAdvicePortalTypeIds
from plonemeeting.portal.utils import getCustomAdapter
from plonemeeting.portal.utils import getCustomSchemaFields
from plonemeeting.portal.utils import listifySignatures
from plonemeeting.portal.utils import reindex_object
from plonemeeting.portal.utils import translate_list
from plonemeeting.portal.utils import updateAnnexesAccess
from plonemeeting.portal.validators import WorkflowInterfacesValidator
from plonemeeting.portal.widgets.pm_checkbox import PMCheckBoxFieldWidget
from plonemeeting.portal.widgets.pm_orderedselect import PMOrderedSelectFieldWidget
from plonemeeting.portal.widgets.pm_richtext import PMRichTextFieldWidget
from plonemeeting.portal.widgets.pm_textarea import PMTextAreaFieldWidget
...
class ICertifiedSignaturesRowSchema(Interface):
    ...
    signature_number = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.numbers_vocabulary',
        required=False,
    )
    ...
    held_position = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.selectable_contacts_vocabulary',
        required=False,
    )
...
class IInsertingMethodsOnAddItemRowSchema(Interface):
    ...
    inserting_method = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.inserting_methods_vocabulary',
        required=False,
    )
    ...
    reverse = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.boolean_vocabulary',
        required=False,
    )
...
class IMeetingConfigsToCloneToRowSchema(Interface):
    ...
    meeting_config = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.meeting_configs_to_clone_to_vocabulary',
        required=False,
    )
    ...
    trigger_workflow_transitions_until = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.transitions_until_presented_vocabulary',
        required=False,
    )
...
class ICssTransformsRowSchema(Interface):
    ...
    powerobservers = schema.List(
        ...
        value_type=schema.Choice(vocabulary=u'plonemeeting.portal.vocabularies.power_observers_types_vocabulary'),
        required=False,
    )
...
class IOnTransitionFieldTransformsRowSchema(Interface):
    ...
    transition = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.item_transitions_vocabulary',
        required=False,
    )
    ...
    field_name = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.item_rich_text_fields_vocabulary',
        required=False,
    )
...
class IOnMeetingTransitionItemActionRowSchema(Interface):
    ...
    meeting_transition = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.meeting_transitions_vocabulary',
        required=False,
    )
    ...
    item_action = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.executable_item_actions_vocabulary',
        required=False,
    )
...
class ICustomAdvisersRowSchema(Interface):
    ...
    org = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.active_orgs_for_custom_advisers_vocabulary',
        required=False,
    )
...
class IPowerObserversRowSchema(Interface):
    ...
    item_states = schema.List(
        ...
        value_type=schema.Choice(vocabulary=u'plonemeeting.portal.vocabularies.item_states_vocabulary'),
        required=False,
    )
    ...
    meeting_states = schema.List(
        ...
        value_type=schema.Choice(vocabulary=u'plonemeeting.portal.vocabularies.meeting_states_vocabulary'),
        required=False,
    )
...
class ILabelsConfigRowSchema(Interface):
    ...
    label_id = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.configftwlabelsvocabulary',
        required=False,
    )
    ...
    view_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_attribute_visible_for_with_meeting_managers_vocabulary'),
        required=False,
    )
...
class IItemFieldsConfigRowSchema(Interface):
    ...
    name = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.item_fields_config_vocabulary',
        required=False,
    )
...
class ICommitteesRowSchema(Interface):
    ...
    default_attendees = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.selectable_committee_attendees_vocabulary'),
        required=False,
    )
    ...
    using_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.selectable_proposing_groups_vocabulary'),
        required=False,
    ...
    auto_from = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.selectable_committee_auto_from_vocabulary'),
        required=False,
    )
    ...
    supplements = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.numbers_from_zero_vocabulary',
        required=False,
    )
    ...
    enabled = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.committees_enabled_vocabulary',
        required=False,
    )
...
class IMeetingConfig(IMeetingConfigMarker):
    ...
    item_icon_color = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.item_icon_colors_vocabulary',
        required=False,
    ...
    config_group = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.config_groups_vocabulary',
        required=False,
    ...
    yearly_init_meeting_numbers = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.yearlyinitmeetingnumbersvocabulary'),
        required=False,
    ...
    ordered_contacts = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.selectableassemblymembersvocabulary'),
        required=False,
    ...
    ordered_item_initiators = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.selectableiteminitiatorsvocabulary'),
        required=False,
    ...
    used_item_attributes = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.used_item_attributes_vocabulary'),
        required=False,
    ...
    historized_item_attributes = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_attributes_vocabulary'),
        required=False,
    ...
    record_item_history_states = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_states_vocabulary'),
        required=False,
    ...
    used_meeting_attributes = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.used_meeting_attributes_vocabulary'),
        required=False,
    ...
    ordered_associated_organizations = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.detailedorganizationsvocabulary'),
        required=False,
    ...
    selectable_privacies = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.selectableprivaciesvocabulary'),
        required=False,
    ...
    item_fields_to_keep_config_sorting_for = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_fields_to_keep_config_sorting_for_vocabulary'),
        required=False,
    ...
    xhtml_transform_fields = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.all_rich_text_fields_vocabulary'),
        required=False,
    ...
    xhtml_transform_types = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.transform_types_vocabulary'),
        required=False,
    ...
    item_auto_sent_to_other_mc_states = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_auto_sent_to_other_mc_states_vocabulary'),
        required=False,
    ...
    contents_kept_on_sent_to_other_mc = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.contents_kept_on_sent_to_other_mc_vocabulary'),
        required=False,
    ...
    advices_kept_on_sent_to_other_mc = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.askedadvicesvocabulary'),
        required=False,
    ...
    annex_to_print_mode = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.annex_to_print_modes_vocabulary',
        required=False,
    ...
    transitions_to_confirm = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.all_transitions_vocabulary'),
        required=False,
    ...
    meeting_present_item_when_no_current_meeting_states = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.meeting_states_vocabulary'),
        required=False,
    ...
    item_columns = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_columns_vocabulary'),
        required=False,
    ...
    available_items_list_visible_columns = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.available_items_list_visible_columns_vocabulary'),
        required=False,
    ...
    items_list_visible_columns = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.items_list_visible_columns_vocabulary'),
        required=False,
    ...
    item_actions_column_config = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_actions_column_config_vocabulary'),
        required=False,
    ...
    meeting_columns = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.meeting_columns_vocabulary'),
        required=False,
    ...
    enabled_annexes_batch_actions = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.annexes_batch_actions_vocabulary'),
        required=False,
    ...
    display_available_items_to = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.display_available_items_to_vocabulary'),
        required=False,
    ...
    redirect_to_next_meeting = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.redirect_to_next_meeting_vocabulary'),
        required=False,
    ...
    items_visible_fields = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.items_visible_fields_vocabulary'),
        required=False,
    ...
    items_not_viewable_visible_fields = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.items_not_viewable_visible_fields_vocabulary'),
        required=False,
    ...
    items_list_visible_fields = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.items_list_visible_fields_vocabulary'),
        required=False,
    ...
    to_do_list_searches = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.to_do_list_searches_vocabulary'),
        required=False,
    ...
    dashboard_items_listings_filters = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.dashboard_items_listings_filters_vocabulary'),
        required=False,
    ...
    dashboard_meetings_listings_filters = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.dashboard_meetings_listings_filters_vocabulary'),
        required=False,
    ...
    groups_hidden_in_dashboard_filter = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.proposinggroupsvocabulary'),
        required=False,
    ...
    users_hidden_in_dashboard_filter = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.creatorsvocabulary'),
        required=False,
    ...
    max_shown_listings = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.results_per_page_vocabulary',
        required=False,
    ...
    mail_mode = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.mail_modes_vocabulary',
        required=False,
    ...
    mail_item_events = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_events_vocabulary'),
        required=False,
    ...
    mail_meeting_events = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.meeting_events_vocabulary'),
        required=False,
    ...
    selectable_advisers = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.selectable_advisers_vocabulary'),
        required=False,
    ...
    keep_access_to_item_when_advice = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.keep_access_to_item_when_advice_vocabulary',
        required=False,
    ...
    advice_style = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.vocabularies.advice_styles_vocabulary',
        required=False,
    ...
    power_advisers_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.active_orgs_for_power_advisers_vocabulary'),
        required=False,
    ...
    selectable_copy_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.selectable_copy_groups_vocabulary'),
        required=False,
    ...
    hide_history_to = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.config_hide_history_to_vocabulary'),
        required=False,
    ...
    hide_not_viewable_linked_items_to = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.power_observers_types_vocabulary'),
        required=False,
    ...
    annex_restrict_shown_and_editable_attributes = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.annex_restrict_shown_and_editable_attributes_vocabulary'),
        required=False,
    ...
    item_annex_confidential_visible_for = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.item_attribute_visible_for_vocabulary'),
        required=False,
    ...
    advice_annex_confidential_visible_for = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.advice_annex_confidential_visible_for_vocabulary'),
        required=False,
    ...
    meeting_annex_confidential_visible_for = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.meeting_annex_confidential_visible_for_vocabulary'),
        required=False,
    ...
    ordered_committee_contacts = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.every_heldpositions_vocabulary'),
        required=False,
    ...
    votes_encoder = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.votes_encoders_vocabulary'),
        required=False,
    ...
    used_poll_types = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.poll_types_vocabulary'),
        required=False,
    ...
    used_vote_values = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.allvotevaluesvocabulary'),
        required=False,
    ...
    meeting_item_templates_to_store_as_annex = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.portal.vocabularies.itemtemplatesstorableasannexvocabulary'),
        required=False,
...
class MeetingConfig(Container):
    ...
    def validate_committees(self, value):
        ...
        vocab = get_vocab(
            self,
            "plonemeeting.portal.vocabularies.selectable_committees_vocabulary",
            only_factory=True)
    ...
    def validate_workflowAdaptations(self, values):
        ...
        from plonemeeting.portal.MeetingConfig import MeetingConfig as ATMeetingConfig
        dependencies = {
    ...
    def validate_mailItemEvents(self, values):
        ...
        if 'adviceToGive' in values and 'adviceToGiveByUser' in values:
            vocab_factory = getUtility(IVocabularyFactory,
                                       name=u'plonemeeting.portal.vocabularies.item_events_vocabulary')
    ...
    def getCategoriesIds_cachekey(method, self, catType='categories', onlySelectable=True, userId=None):
        ...
        date = get_cachekey_volatile('plonemeeting.portal.MeetingConfig.getCategoriesIds')
    ...
    def get_labels_vocab(
            self,
            only_personal=True,
            vocab_name="plonemeeting.portal.vocabularies.ftwlabelsvocabulary"):
        """ """
    ...
    def listSelectableContacts(self):
        ...
        vocab_factory = getUtility(
            IVocabularyFactory,
            "plonemeeting.portal.vocabularies.every_heldpositions_vocabulary")
        vocab = vocab_factory(self)
    ...
    def listSelectableCommitteeAttendees(self):
        ...
        vocab = get_vocab(
            self, "plonemeeting.portal.vocabularies.selectable_committee_attendees_vocabulary")
        res = [(term.value, term.title) for term in vocab._terms]
        return DisplayList(res)
    ...
    def listSelectableProposingGroups(self):
        """Vocabulary for the MeetingConfig.committees field."""
        vocab = get_vocab(
            self, "plonemeeting.portal.vocabularies.proposinggroupsvocabulary")
        res = [(term.value, term.title) for term in vocab._terms]
        return DisplayList(res)
    ...
    def listSelectableCommitteeAutoFrom(self):
        ...
        categories_vocab = get_vocab(
            self, "plonemeeting.portal.vocabularies.categoriesvocabulary")
        res += [('category__' + term.value, 'Cat.: ' + term.title)
                for term in categories_vocab._terms]
        # classifiers
        classifiers_vocab = get_vocab(
            self, "plonemeeting.portal.vocabularies.classifiersvocabulary")
