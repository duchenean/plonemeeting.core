...
from plonemeeting.portal.events import _invalidateAttendeesRelatedCache
from plonemeeting.portal.utils import _prefixed_gn_position_name
from plonemeeting.portal.utils import plain_render
...
class IPMHeldPosition(IHeldPosition):
    ...
    usages = zope.schema.List(
        ...
        value_type=zope.schema.Choice(
            vocabulary="plonemeeting.portal.vocabularies.pmheldposition_usagesvocabulary"),
        required=False,
        default=[],
    )
    ...
    defaults = zope.schema.List(
        title=_("Defaults"),
        value_type=zope.schema.Choice(
            vocabulary="plonemeeting.portal.vocabularies.pmheldposition_defaultsvocabulary"),
        required=False,
        default=[],
    )
