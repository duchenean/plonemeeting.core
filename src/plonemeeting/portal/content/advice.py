...
from plonemeeting.portal.utils import findMeetingAdvicePortalType
from plonemeeting.portal.utils import get_event_field_data
from plonemeeting.portal.utils import getAdvicePortalTypeIds
from plonemeeting.portal.utils import getWorkflowAdapter
from plonemeeting.portal.utils import historize_object_data
...
class IMeetingAdvice(IDXMeetingContent):
    ...
    advice_group = LocalRoleField(
        ...
        vocabulary=u'plonemeeting.portal.content.advice.advice_group_vocabulary',
        required=True,
    )
    ...
    advice_type = schema.Choice(
        ...
        vocabulary=u'plonemeeting.portal.content.advice.advice_type_vocabulary',
        required=True,
    )
