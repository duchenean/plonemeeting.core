...
class MeetingCategoryColumn(ItemCategoryColumn):
    ...
    vocabulary = u'plonemeeting.portal.vocabularies.meeting_categories_vocabulary'
...
class ItemProposingGroupColumn(VocabularyColumn):
    ...
    vocabulary = u'plonemeeting.portal.vocabularies.everyorganizationsvocabulary'
...
class ItemProposingGroupAcronymColumn(AbbrColumn):
    ...
    vocabulary = u'plonemeeting.portal.vocabularies.everyorganizationsacronymsvocabulary'
    full_vocabulary = u'plonemeeting.portal.vocabularies.everyorganizationsvocabulary'
...
class ItemCopyGroupsColumn(VocabularyColumn):
    ...
    vocabulary = u'plonemeeting.portal.Groups'
    the_object = True
...
class ItemCommitteesColumn(VocabularyColumn):
    ...
    vocabulary = u'plonemeeting.portal.vocabularies.selectable_committees_vocabulary'


class ItemCommitteesAcronymColumn(AbbrColumn):
    """A column that display the MeetingItem.committees acronym."""
    attrName = 'committees_index'
    vocabulary = u'plonemeeting.portal.vocabularies.selectable_committees_acronyms_vocabulary'
    full_vocabulary = u'plonemeeting.portal.vocabularies.selectable_committees_vocabulary'
