...
from plonemeeting.core.config import ALL_ADVISERS_GROUP_VALUE
...
from plonemeeting.core.utils import getHistoryTexts
...
class ItemPrettyLinkAdapter(PrettyLinkAdapter):
    ...
    def getLink_cachekey(method, self):
        ...
        destMeetingConfigIds = get_vocab_values(
            self.context, 'plonemeeting.core.vocabularies.other_mcs_clonable_to_vocabulary')
