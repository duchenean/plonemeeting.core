...
class Migrate_To_4107(Migrator):
    ...
    def _registerMeetingFactoryTypes(self):
        ...
        self.ps.runImportStepFromProfile('profile-plonemeeting.core:default', 'factorytool')
    ...
    def run(self, from_migration_to_41=False):
        ...
        # reapply typeinfo as imio.zamqp.pm typeinfo was merged into plonemeeting.core
