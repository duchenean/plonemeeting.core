...
class Migrator(BaseMigrator):
    ...
    def __init__(self, context):
        ...
        self.profile_name = u'profile-plonemeeting.core:default'

    def reorderSkinsLayers(self):
        """Reapply skins of plonemeeting.core + self.profile_name."""
        # re-apply the PloneMeeting skins and the self.profile_name skin if different
        self.runProfileSteps('plonemeeting.core',
                             steps=['skins'],
                             profile='default')
        if self.profile_name != u'profile-plonemeeting.core:default':
    ...
    def upgradeDependencies(self):
        ...
        profile_names = self.ps.getDependenciesForProfile(u'profile-plonemeeting.core:default')
    ...
    def updateFacetedFilters(self, xml_filename=None, related_to="items", reorder=True, to_delete=[]):
        ...
        for cfg in self.tool.objectValues('MeetingConfig'):
            ...
            cleanRamCacheFor('plonemeeting.core.adapters.compute_criteria')
