...
from plonemeeting.core.ToolPloneMeeting import _TOOL_AT_TO_DX
...
class Migrate_To_4300(Migrator):
    ...
    def _migrateMeetingConfigsToDexterity(self):
        ...
        load_type_from_package('MeetingConfig', 'plonemeeting.core:default')
        ...
        for attr in _AT_ARTIFACTS:
            if hasattr(tool, attr):
                try:
                    ...
                    pass
        load_type_from_package('ToolPloneMeeting', 'plonemeeting.core:default')
