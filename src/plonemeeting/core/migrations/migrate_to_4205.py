...
from plonemeeting.core.setuphandlers import _configurePortalRepository
from plonemeeting.core.utils import get_dx_data
...
class Migrate_To_4205(Migrator):
    ...
    def _updateConfigCommitteesAndVotesResult(self):
        ...
        self.runProfileSteps('plonemeeting.core', steps=['rolemap', 'workflow'], profile='default')
