...
# from plonemeeting.core.config import CKEDITOR_MENUSTYLES_CUSTOMIZED_MSG
from plonemeeting.core.config import HAS_LDAP
from plonemeeting.core.config import HAS_SOLR
# P6 migration: AMQP integration to be reimplemented in Stage D.
# from plonemeeting.core.config import HAS_ZAMQP
from plonemeeting.core.config import ManageOwnOrganizationFields
