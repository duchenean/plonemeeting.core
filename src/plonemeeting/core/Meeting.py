...
from plonemeeting.core.browser.itemchangeorder import _compute_value_to_add
from plonemeeting.core.browser.itemchangeorder import _is_integer
from plonemeeting.core.browser.itemchangeorder import _to_integer
from plonemeeting.core.browser.itemchangeorder import _use_same_integer
from plonemeeting.core.browser.itemvotes import clean_voters_linked_to
...
# from plonemeeting.core.utils import getStatesBefore
...
from plonemeeting.core.utils import display_as_html
...
from plonemeeting.core.utils import getDateFromDelta
...
from plonemeeting.core.utils import ItemDuplicatedFromConfigEvent
from plonemeeting.core.utils import MeetingLocalRolesUpdatedEvent
...
class Meeting(OrderedBaseFolder, BrowserDefaultMixin):
    ...
    def setDate(self, value, **kwargs):
        ...
        if not value == current_date:
            ...
            # clean cache for "plonemeeting.core.vocabularies.meetingdatesvocabulary"
            invalidate_cachekey_volatile_for(
                "plonemeeting.core.vocabularies.meetingdatesvocabulary", get_again=True)
    ...
    def _finalize_item_insert(self, items_to_update=[]):
        ...
        cleanRamCacheFor('plonemeeting.core.MeetingItem.getMeeting')
    ...
    def at_post_create_script(self):
        ...
        invalidate_cachekey_volatile_for('plonemeeting.core.Meeting.modified', get_again=True)
    ...
    def at_post_edit_script(self):
        ...
        # invalidate last meeting modified
        invalidate_cachekey_volatile_for(
            'plonemeeting.core.Meeting.modified', get_again=True)
        # invalidate item voters vocabulary in case new voters (un)selected
        invalidate_cachekey_volatile_for(
            'plonemeeting.core.vocabularies.itemvotersvocabulary', get_again=True)
        # invalidate assembly async load on meeting
        invalidate_cachekey_volatile_for(
            'plonemeeting.core.browser.async.AsyncLoadMeetingAssemblyAndSignatures',
            get_again=True)
        if need_reindex:
            self.reindexObject()
