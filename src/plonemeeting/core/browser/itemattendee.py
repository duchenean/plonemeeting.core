...
from plonemeeting.core.browser.itemassembly import _itemsToUpdate
from plonemeeting.core.browser.itemassembly import validate_apply_until_item_number
...
from plonemeeting.core.utils import redirect
...
class IByeByeAttendee(IBaseAttendee):
    ...
    not_present_type = schema.Choice(
        ...
        description=_(u""),
        vocabulary=u"plonemeeting.core.vocabularies.not_present_type_vocabulary",
        required=True)
...
class IRedefineSignatory(IBaseAttendee):
    ...
    signature_number = schema.Choice(
        ...
        required=True,
        vocabulary=u"plonemeeting.core.vocabularies.numbersvocabulary")
