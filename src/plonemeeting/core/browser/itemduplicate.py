...
class IDuplicateItem(form.Schema):
    ...
    annex_ids = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u"plonemeeting.core.vocabularies.item_duplication_contained_annexes_vocabulary"),
    )
    ...
    annex_decision_ids = schema.List(
        ...
        required=False,
        value_type=schema.Choice(
            vocabulary=u"plonemeeting.core.vocabularies.item_duplication_contained_decision_annexes_vocabulary"),
    )
