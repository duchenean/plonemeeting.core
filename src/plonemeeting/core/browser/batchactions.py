...
from plonemeeting.core.content.advice import _advice_type_default
from plonemeeting.core.ftw_labels.utils import filter_access_global_labels
from plonemeeting.core.utils import _add_advice
from plonemeeting.core.utils import displaying_available_items
from plonemeeting.core.utils import is_operational_user
...
class MeetingStoreItemsPodTemplateAsAnnexBatchActionForm(BaseBatchActionForm):
    ...
    def _update(self):
        self.fields += Fields(schema.Choice(
            ...
            vocabulary='plonemeeting.core.vocabularies.itemtemplatesstorableasannexvocabulary'))
...
class UpdateGroupsInChargeBatchActionForm(PMBaseARUOBatchActionForm):
    ...
    def _vocabulary(self):
        return 'plonemeeting.core.vocabularies.itemgroupsinchargevocabulary'
...
class UpdateCopyGroupsBatchActionForm(PMBaseARUOBatchActionForm):
    ...
    def _vocabulary(self):
        return 'plonemeeting.core.vocabularies.copygroupsvocabulary'
...
class UpdateCommitteesBatchActionForm(PMBaseARUOBatchActionForm):
    ...
    def _vocabulary(self):
        return 'plonemeeting.core.vocabularies.item_selectable_committees_vocabulary'
...
class AddAdviceBatchActionForm(BaseBatchActionForm):
    ...
    def _advice_group_vocabulary(self):
        ...
        return get_vocab(
            self.context,
            'plonemeeting.core.content.advice.advice_group_vocabulary',
...
class PMConcatenateAnnexesBatchActionForm(ConcatenateAnnexesBatchActionForm):
    ...
    def _annex_types_vocabulary(self):
        return "plonemeeting.core.vocabularies.icon_item_annex_types_vocabulary"
