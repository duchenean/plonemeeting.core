...
from plonemeeting.core.browser.itemattendee import BaseAttendeeForm
from plonemeeting.core.browser.itemattendee import IBaseAttendee
...
from plonemeeting.core.widgets.pm_number import PMNumberFieldWidget
from plonemeeting.core.widgets.pm_selectreadonly import PMSelectReadonlyWidget
...
class DisplaySelectAllProvider(ContentProviderBase):
    ...
    def render(self):
        used_vote_terms = get_vocab(
            self.context, "plonemeeting.core.vocabularies.usedvotevaluesvocabulary")
...
class IVote(Interface):
    ...
    voter_uid = schema.Choice(
        title=u'Voter UID',
        required=False,
        vocabulary="plonemeeting.core.vocabularies.itemvotersvocabulary", )
    ...
    vote_value = schema.Choice(
        ...
        required=False,
        vocabulary="plonemeeting.core.vocabularies.usedvotevaluesvocabulary", )
...
def secret_votes_default(context):
    ...
    used_vote_terms = get_vocab(
        context,
        "plonemeeting.core.vocabularies.usedvotevaluesvocabulary",
        vote_number=vote_number)
