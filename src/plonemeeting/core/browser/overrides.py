...
from plonemeeting.core.interfaces import IUtils
...
from plonemeeting.core.config import HAS_RESTAPI
...
class PMRenderTermView(RenderTermPortletView):
    ...
    def number_of_items_cachekey(method, self, init=False):
        ...
        date = get_cachekey_volatile('plonemeeting.core.MeetingItem.modified', method)
...
class PMUtils(BrowserView):
    ...
    def translate(self, vocab, value, widget=None):
        ...
        # XXX begin changes by plonemeeting.core
        ...
        if IConfigElement.providedBy(self.context):
            ...
            value = ', '.join(nvalues)
        # XXX end changes by plonemeeting.core
        return value
