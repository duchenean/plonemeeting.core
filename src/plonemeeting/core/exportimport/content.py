...
from plonemeeting.core.profiles import DEFAULT_USER_PASSWORD
    ...
    def _finishConfigFor(self, cfg, data):
        ...
        if data.addContactsCSV:
            ...
            if IDexterityContent.providedBy(cfg):
                vocab = get_vocab(cfg, u'plonemeeting.core.vocabularies.selectableassemblymembersvocabulary')
    ...
    def find_binary(self, path):
        ...
        try:
            ...
            pm_path = os.path.join(
                os.path.dirname(plonemeeting.core.__file__),
                'profiles/testing',
                file_folder,
                filename)
            f = open(pm_path, 'rb')
