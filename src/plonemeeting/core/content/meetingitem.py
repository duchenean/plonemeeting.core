...
field set defined in ``plonemeeting/core/MeetingItem.py``. Every AT
...
The AT class in ``plonemeeting/core/MeetingItem.py`` remains the
...
from plonemeeting.core.config import CONSIDERED_NOT_GIVEN_ADVICE_VALUE
...
from plonemeeting.core.config import DUPLICATE_EVENT_ACTION
...
from plonemeeting.core.config import HIDDEN_DURING_REDACTION_ADVICE_VALUE
from plonemeeting.core.config import HIDE_DECISION_UNDER_WRITING_MSG
from plonemeeting.core.config import INSERTING_ON_ITEM_DECISION_FIRST_WORDS_NB
from plonemeeting.core.config import ITEM_COMPLETENESS_ASKERS
from plonemeeting.core.config import ITEM_COMPLETENESS_EVALUATORS
from plonemeeting.core.config import ITEM_LABELS_ACCESS_CACHE_ATTR
...
from plonemeeting.core.config import NOT_GIVEN_ADVICE_VALUE
from plonemeeting.core.config import NOT_VOTABLE_LINKED_TO_VALUE
from plonemeeting.core.config import PMMessageFactory as _
from plonemeeting.core.config import ReadBudgetInfos
from plonemeeting.core.config import READER_USECASES
from plonemeeting.core.config import REINDEX_NEEDED_MARKER
...
from plonemeeting.core.config import WriteCommitteeFields
from plonemeeting.core.config import WriteDecision
from plonemeeting.core.config import WriteInternalNotes
from plonemeeting.core.config import WriteItemMeetingManagerFields
from plonemeeting.core.config import WriteMarginalNotes
from plonemeeting.core.content.meeting import Meeting
from plonemeeting.core.events import item_added_or_initialized
from plonemeeting.core.ftw_labels.utils import compute_labels_access
from plonemeeting.core.ftw_labels.utils import get_labels
from plonemeeting.core.interfaces import IMeetingItem as IMeetingItemMarker
from plonemeeting.core.model.adaptations import get_waiting_advices_infos
from plonemeeting.core.model.adaptations import RETURN_TO_PROPOSING_GROUP_MAPPINGS
from plonemeeting.core.utils import _addManagedPermissions
from plonemeeting.core.utils import _base_extra_expr_ctx
from plonemeeting.core.utils import _clear_local_roles
from plonemeeting.core.utils import _get_category
from plonemeeting.core.utils import _storedItemNumber_to_itemNumber
from plonemeeting.core.utils import addDataChange
from plonemeeting.core.utils import AdvicesUpdatedEvent
from plonemeeting.core.utils import checkMayQuickEdit
...
from plonemeeting.core.utils import decodeDelayAwareId
...
from plonemeeting.core.utils import get_states_before
...
from plonemeeting.core.utils import getWorkflowAdapter
from plonemeeting.core.utils import hasHistory
from plonemeeting.core.utils import is_editing
from plonemeeting.core.utils import is_proposing_group_editor
from plonemeeting.core.utils import isPowerObserverForCfg
from plonemeeting.core.utils import ItemDuplicatedEvent
from plonemeeting.core.utils import ItemDuplicatedToOtherMCEvent
from plonemeeting.core.utils import ItemLocalRolesUpdatedEvent
from plonemeeting.core.utils import meetingExecuteActionOnLinkedItems
from plonemeeting.core.utils import networkdays
...
from plonemeeting.core.utils import rememberPreviousData
from plonemeeting.core.utils import sendMail
from plonemeeting.core.utils import sendMailIfRelevant
...
from plonemeeting.core.widgets.pm_textarea import render_textarea
...
class IMeetingItem(IMeetingItemMarker):
    ...
    proposing_group = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.userproposinggroupsvocabulary',
        required=False,
    )
    ...
    proposing_group_with_group_in_charge = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.userproposinggroupswithgroupsinchargevocabulary',
        required=False,
    )
    ...
    groups_in_charge = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.itemgroupsinchargevocabulary'),
        required=False,
        default=[],
    )
    ...
    associated_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.itemassociatedgroupsvocabulary'),
        required=False,
        default=[],
    )
    ...
    category = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.categoriesvocabulary',
        required=False,
    )
    ...
    classifier = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.classifiersvocabulary',
        required=False,
    )
    ...
    committees = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_selectable_committees_vocabulary'),
        required=True,
        default=[],
    )
    ...
    list_type = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.listtypesvocabulary',
        required=False,
        default=u'normal',
    )
    ...
    emergency = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.item_emergencies_vocabulary',
        required=False,
    ...
    preferred_meeting = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.item_meetings_accepting_items_vocabulary',
        required=False,
    ...
    item_tags = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_tags_vocabulary'),
        required=False,
        default=[],
    )
    ...
    optional_advisers = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.itemoptionaladvicesvocabulary'),
        required=False,
        default=[],
    )
    ...
    item_initiator = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_initiators_vocabulary'),
        required=False,
        default=[],
    )
    ...
    meeting_transition_inserting_me = schema.Choice(
        ...
        description=_(u'meeting_transition_inserting_me_descr',
                      default=u'Meetingtransitioninsertingme'),
        vocabulary=u'plonemeeting.core.vocabularies.item_meeting_transitions_vocabulary',
        required=False,
    )
    ...
    copy_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.itemcopygroupsvocabulary'),
        required=False,
        default=[],
    )
    ...
    restricted_copy_groups = schema.List(
        ...
        description=_(u'descr_field_vieawable_by_everyone', default=u''),
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.itemrestrictedcopygroupsvocabulary'),
        required=False,
        default=[],
    )
    ...
    poll_type = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.polltypesvocabulary',
        required=False,
        default=u'freehand',
    )
    ...
    other_meeting_configs_clonable_to = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.other_mcs_clonable_to_vocabulary'),
        required=False,
        default=[],
    )
    ...
    other_meeting_configs_clonable_to_emergency = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.'
    ...
    privacy = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.privaciesvocabulary',
        required=False,
        default=u'public',
    )
    ...
    completeness = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.item_completeness_vocabulary',
        required=False,
...
class MeetingItem(Container):
    ...
    the AT module ``plonemeeting/core/MeetingItem.py`` still exists
            ...
            for removedAdviser in removedAdvisers:
                ...
                if removedAdviser in givenAdvices and \
                   givenAdvices[removedAdviser]['optional'] is True:
                    vocab = get_vocab(self, u'plonemeeting.core.vocabularies.itemoptionaladvicesvocabulary')
    ...
    def getMeetingToInsertIntoWhenNoCurrentMeetingObjectPath_cachekey(method, self):
        ...
        date_date = get_cachekey_volatile('plonemeeting.core.Meeting.date')
        date_review_state = get_cachekey_volatile('plonemeeting.core.Meeting.review_state')
        tool = api.portal.get_tool('portal_plonemeeting')
        cfg = tool.getMeetingConfig(self)
    ...
    def _findOrderFor(self, insertMethod):
        ...
        if insertMethod == 'on_list_type':
            ...
            values = get_vocab_values(
                self,
                'plonemeeting.core.vocabularies.other_mcs_clonable_to_vocabulary')
            if not toCloneTo:
                res = len(values) + 1
            else:
            ...
            factory = queryUtility(IVocabularyFactory,
                                   'plonemeeting.core.vocabularies.polltypesvocabulary')
    ...
    def displayOtherMeetingConfigsClonableTo(self):
        ...
        tool = api.portal.get_tool('portal_plonemeeting')
        vocab = get_vocab(self, 'plonemeeting.core.vocabularies.other_mcs_clonable_to_vocabulary')
    ...
    def displayCopyGroups(self, restricted=False):
        ...
        portal_url = api.portal.get().absolute_url()
        vocab_name = (
            u'plonemeeting.core.vocabularies.itemrestrictedcopygroupsvocabulary'
            if restricted else
