...
from plonemeeting.core.compat import IntDisplayList
...
from plonemeeting.core.config import ADVICE_TYPES
from plonemeeting.core.config import BUDGETIMPACTEDITORS_GROUP_SUFFIX
from plonemeeting.core.config import CLONE_TO_OTHER_MC_ACTION_SUFFIX
from plonemeeting.core.config import CLONE_TO_OTHER_MC_EMERGENCY_ACTION_SUFFIX
from plonemeeting.core.config import DEFAULT_ITEM_COLUMNS
from plonemeeting.core.config import DEFAULT_LIST_TYPES
from plonemeeting.core.config import DEFAULT_MEETING_COLUMNS
from plonemeeting.core.config import EXECUTE_EXPR_VALUE
from plonemeeting.core.config import ITEM_DEFAULT_TEMPLATE_ID
from plonemeeting.core.config import ITEM_ICON_COLORS
from plonemeeting.core.config import ITEM_INSERT_METHODS
from plonemeeting.core.config import ITEMTEMPLATESMANAGERS_GROUP_SUFFIX
from plonemeeting.core.config import ManageItemCategoryFields
from plonemeeting.core.config import MEETING_REMOVE_MOG_WFA
...
from plonemeeting.core.config import NOT_ENCODED_VOTE_VALUE
from plonemeeting.core.config import PMMessageFactory as _
from plonemeeting.core.config import READER_USECASES
from plonemeeting.core.config import TOOL_FOLDER_ANNEX_TYPES
from plonemeeting.core.config import TOOL_FOLDER_CATEGORIES
from plonemeeting.core.config import TOOL_FOLDER_CLASSIFIERS
from plonemeeting.core.config import TOOL_FOLDER_ITEM_TEMPLATES
from plonemeeting.core.config import TOOL_FOLDER_MEETING_CATEGORIES
from plonemeeting.core.config import TOOL_FOLDER_POD_TEMPLATES
from plonemeeting.core.config import TOOL_FOLDER_RECURRING_ITEMS
from plonemeeting.core.config import TOOL_FOLDER_SEARCHES
from plonemeeting.core.config import WriteBudgetInfos
from plonemeeting.core.config import WriteHarmlessConfig
...
from plonemeeting.core.interfaces import IMeetingConfig as IMeetingConfigMarker
...
from plonemeeting.core.model.adaptations import _performWorkflowAdaptations
from plonemeeting.core.profiles import MeetingConfigDescriptor
from plonemeeting.core.utils import _base_extra_expr_ctx
from plonemeeting.core.utils import computeCertifiedSignatures
from plonemeeting.core.utils import createOrUpdatePloneGroup
...
from plonemeeting.core.utils import get_dx_schema
...
from plonemeeting.core.utils import getCustomSchemaFields
from plonemeeting.core.utils import listifySignatures
from plonemeeting.core.utils import reindex_object
from plonemeeting.core.utils import translate_list
from plonemeeting.core.utils import updateAnnexesAccess
from plonemeeting.core.validators import WorkflowInterfacesValidator
from plonemeeting.core.widgets.pm_checkbox import PMCheckBoxFieldWidget
from plonemeeting.core.widgets.pm_orderedselect import PMOrderedSelectFieldWidget
from plonemeeting.core.widgets.pm_richtext import PMRichTextFieldWidget
from plonemeeting.core.widgets.pm_textarea import PMTextAreaFieldWidget
...
class ICertifiedSignaturesRowSchema(Interface):
    ...
    signature_number = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.numbers_vocabulary',
        required=False,
    )
    ...
    held_position = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.selectable_contacts_vocabulary',
        required=False,
    )
...
class IInsertingMethodsOnAddItemRowSchema(Interface):
    ...
    inserting_method = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.inserting_methods_vocabulary',
        required=False,
    )
    ...
    reverse = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.boolean_vocabulary',
        required=False,
    )
...
class IMeetingConfigsToCloneToRowSchema(Interface):
    ...
    meeting_config = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.meeting_configs_to_clone_to_vocabulary',
        required=False,
    )
    ...
    trigger_workflow_transitions_until = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.transitions_until_presented_vocabulary',
        required=False,
    )
...
class ICssTransformsRowSchema(Interface):
    ...
    powerobservers = schema.List(
        ...
        value_type=schema.Choice(vocabulary=u'plonemeeting.core.vocabularies.power_observers_types_vocabulary'),
        required=False,
    )
...
class IOnTransitionFieldTransformsRowSchema(Interface):
    ...
    transition = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.item_transitions_vocabulary',
        required=False,
    )
    ...
    field_name = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.item_rich_text_fields_vocabulary',
        required=False,
    )
...
class IOnMeetingTransitionItemActionRowSchema(Interface):
    ...
    meeting_transition = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.meeting_transitions_vocabulary',
        required=False,
    )
    ...
    item_action = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.executable_item_actions_vocabulary',
        required=False,
    )
...
class ICustomAdvisersRowSchema(Interface):
    ...
    org = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.active_orgs_for_custom_advisers_vocabulary',
        required=False,
    )
...
class IPowerObserversRowSchema(Interface):
    ...
    item_states = schema.List(
        ...
        value_type=schema.Choice(vocabulary=u'plonemeeting.core.vocabularies.item_states_vocabulary'),
        required=False,
    )
    ...
    meeting_states = schema.List(
        ...
        value_type=schema.Choice(vocabulary=u'plonemeeting.core.vocabularies.meeting_states_vocabulary'),
        required=False,
    )
...
class ILabelsConfigRowSchema(Interface):
    ...
    label_id = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.configftwlabelsvocabulary',
        required=False,
    )
    ...
    view_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_attribute_visible_for_with_meeting_managers_vocabulary'),
        required=False,
    )
...
class IItemFieldsConfigRowSchema(Interface):
    ...
    name = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.item_fields_config_vocabulary',
        required=False,
    )
...
class ICommitteesRowSchema(Interface):
    ...
    default_attendees = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.selectable_committee_attendees_vocabulary'),
        required=False,
    )
    ...
    using_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.selectable_proposing_groups_vocabulary'),
        required=False,
    ...
    auto_from = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.selectable_committee_auto_from_vocabulary'),
        required=False,
    )
    ...
    supplements = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.numbers_from_zero_vocabulary',
        required=False,
    )
    ...
    enabled = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.committees_enabled_vocabulary',
        required=False,
    )
...
class IMeetingConfig(IMeetingConfigMarker):
    ...
    item_icon_color = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.item_icon_colors_vocabulary',
        required=False,
    ...
    config_group = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.config_groups_vocabulary',
        required=False,
    ...
    yearly_init_meeting_numbers = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.yearlyinitmeetingnumbersvocabulary'),
        required=False,
    ...
    ordered_contacts = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.selectableassemblymembersvocabulary'),
        required=False,
    ...
    ordered_item_initiators = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.selectableiteminitiatorsvocabulary'),
        required=False,
    ...
    used_item_attributes = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.used_item_attributes_vocabulary'),
        required=False,
    ...
    historized_item_attributes = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_attributes_vocabulary'),
        required=False,
    ...
    record_item_history_states = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_states_vocabulary'),
        required=False,
    ...
    used_meeting_attributes = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.used_meeting_attributes_vocabulary'),
        required=False,
    ...
    ordered_associated_organizations = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.detailedorganizationsvocabulary'),
        required=False,
    ...
    selectable_privacies = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.selectableprivaciesvocabulary'),
        required=False,
    ...
    item_fields_to_keep_config_sorting_for = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_fields_to_keep_config_sorting_for_vocabulary'),
        required=False,
    ...
    xhtml_transform_fields = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.all_rich_text_fields_vocabulary'),
        required=False,
    ...
    xhtml_transform_types = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.transform_types_vocabulary'),
        required=False,
    ...
    item_auto_sent_to_other_mc_states = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_auto_sent_to_other_mc_states_vocabulary'),
        required=False,
    ...
    contents_kept_on_sent_to_other_mc = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.contents_kept_on_sent_to_other_mc_vocabulary'),
        required=False,
    ...
    advices_kept_on_sent_to_other_mc = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.askedadvicesvocabulary'),
        required=False,
    ...
    annex_to_print_mode = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.annex_to_print_modes_vocabulary',
        required=False,
    ...
    transitions_to_confirm = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.all_transitions_vocabulary'),
        required=False,
    ...
    meeting_present_item_when_no_current_meeting_states = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.meeting_states_vocabulary'),
        required=False,
    ...
    item_columns = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_columns_vocabulary'),
        required=False,
    ...
    available_items_list_visible_columns = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.available_items_list_visible_columns_vocabulary'),
        required=False,
    ...
    items_list_visible_columns = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.items_list_visible_columns_vocabulary'),
        required=False,
    ...
    item_actions_column_config = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_actions_column_config_vocabulary'),
        required=False,
    ...
    meeting_columns = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.meeting_columns_vocabulary'),
        required=False,
    ...
    enabled_annexes_batch_actions = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.annexes_batch_actions_vocabulary'),
        required=False,
    ...
    display_available_items_to = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.display_available_items_to_vocabulary'),
        required=False,
    ...
    redirect_to_next_meeting = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.redirect_to_next_meeting_vocabulary'),
        required=False,
    ...
    items_visible_fields = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.items_visible_fields_vocabulary'),
        required=False,
    ...
    items_not_viewable_visible_fields = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.items_not_viewable_visible_fields_vocabulary'),
        required=False,
    ...
    items_list_visible_fields = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.items_list_visible_fields_vocabulary'),
        required=False,
    ...
    to_do_list_searches = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.to_do_list_searches_vocabulary'),
        required=False,
    ...
    dashboard_items_listings_filters = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.dashboard_items_listings_filters_vocabulary'),
        required=False,
    ...
    dashboard_meetings_listings_filters = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.dashboard_meetings_listings_filters_vocabulary'),
        required=False,
    ...
    groups_hidden_in_dashboard_filter = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.proposinggroupsvocabulary'),
        required=False,
    ...
    users_hidden_in_dashboard_filter = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.creatorsvocabulary'),
        required=False,
    ...
    max_shown_listings = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.results_per_page_vocabulary',
        required=False,
    ...
    mail_mode = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.mail_modes_vocabulary',
        required=False,
    ...
    mail_item_events = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_events_vocabulary'),
        required=False,
    ...
    mail_meeting_events = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.meeting_events_vocabulary'),
        required=False,
    ...
    selectable_advisers = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.selectable_advisers_vocabulary'),
        required=False,
    ...
    keep_access_to_item_when_advice = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.keep_access_to_item_when_advice_vocabulary',
        required=False,
    ...
    advice_style = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.vocabularies.advice_styles_vocabulary',
        required=False,
    ...
    power_advisers_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.active_orgs_for_power_advisers_vocabulary'),
        required=False,
    ...
    selectable_copy_groups = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.selectable_copy_groups_vocabulary'),
        required=False,
    ...
    hide_history_to = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.config_hide_history_to_vocabulary'),
        required=False,
    ...
    hide_not_viewable_linked_items_to = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.power_observers_types_vocabulary'),
        required=False,
    ...
    annex_restrict_shown_and_editable_attributes = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.annex_restrict_shown_and_editable_attributes_vocabulary'),
        required=False,
    ...
    item_annex_confidential_visible_for = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.item_attribute_visible_for_vocabulary'),
        required=False,
    ...
    advice_annex_confidential_visible_for = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.advice_annex_confidential_visible_for_vocabulary'),
        required=False,
    ...
    meeting_annex_confidential_visible_for = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.meeting_annex_confidential_visible_for_vocabulary'),
        required=False,
    ...
    ordered_committee_contacts = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.every_heldpositions_vocabulary'),
        required=False,
    ...
    votes_encoder = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.votes_encoders_vocabulary'),
        required=False,
    ...
    used_poll_types = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.poll_types_vocabulary'),
        required=False,
    ...
    used_vote_values = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.allvotevaluesvocabulary'),
        required=False,
    ...
    meeting_item_templates_to_store_as_annex = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary=u'plonemeeting.core.vocabularies.itemtemplatesstorableasannexvocabulary'),
        required=False,
...
class MeetingConfig(Container):
    ...
    def validate_committees(self, value):
        ...
        vocab = get_vocab(
            self,
            "plonemeeting.core.vocabularies.selectable_committees_vocabulary",
            only_factory=True)
    ...
    def validate_mailItemEvents(self, values):
        ...
        if 'adviceToGive' in values and 'adviceToGiveByUser' in values:
            vocab_factory = getUtility(IVocabularyFactory,
                                       name=u'plonemeeting.core.vocabularies.item_events_vocabulary')
    ...
    def getCategoriesIds_cachekey(method, self, catType='categories', onlySelectable=True, userId=None):
        ...
        date = get_cachekey_volatile('plonemeeting.core.MeetingConfig.getCategoriesIds')
    ...
    def get_labels_vocab(
            self,
            only_personal=True,
            vocab_name="plonemeeting.core.vocabularies.ftwlabelsvocabulary"):
        """ """
    ...
    def listSelectableContacts(self):
        ...
        vocab_factory = getUtility(
            IVocabularyFactory,
            "plonemeeting.core.vocabularies.every_heldpositions_vocabulary")
        vocab = vocab_factory(self)
    ...
    def listSelectableCommitteeAttendees(self):
        ...
        vocab = get_vocab(
            self, "plonemeeting.core.vocabularies.selectable_committee_attendees_vocabulary")
        res = [(term.value, term.title) for term in vocab._terms]
        return DisplayList(res)
    ...
    def listSelectableProposingGroups(self):
        """Vocabulary for the MeetingConfig.committees field."""
        vocab = get_vocab(
            self, "plonemeeting.core.vocabularies.proposinggroupsvocabulary")
        res = [(term.value, term.title) for term in vocab._terms]
        return DisplayList(res)
    ...
    def listSelectableCommitteeAutoFrom(self):
        ...
        categories_vocab = get_vocab(
            self, "plonemeeting.core.vocabularies.categoriesvocabulary")
        res += [('category__' + term.value, 'Cat.: ' + term.title)
                for term in categories_vocab._terms]
        # classifiers
        classifiers_vocab = get_vocab(
            self, "plonemeeting.core.vocabularies.classifiersvocabulary")
