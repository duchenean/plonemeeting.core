...
from plonemeeting.core.interfaces import IDXMeetingContent
...
from plonemeeting.core.widgets.pm_textarea import get_textarea_value
...
class ICommitteesRowSchema(Interface):
    ...
    row_id = schema.Choice(
        ...
        vocabulary='plonemeeting.core.vocabularies.meeting_selectable_committees_vocabulary',
        required=True)
    ...
    attendees = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary="plonemeeting.core.vocabularies.selectable_committee_attendees_vocabulary"),
        required=False)
...
class IMeeting(IDXMeetingContent):
    ...
    place = MasterSelectField(
        ...
        vocabulary="plonemeeting.core.content.meeting.places_vocabulary",
    ...
    category = schema.Choice(
        ...
        vocabulary="plonemeeting.core.vocabularies.meeting_categories_vocabulary",
        required=False,
    )
    ...
    adopts_next_agenda_of = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary="plonemeeting.core.vocabularies.other_mcs_clonable_to_vocabulary"),
        required=False)
