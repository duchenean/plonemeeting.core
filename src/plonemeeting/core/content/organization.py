...
from plonemeeting.core.events import _invalidateOrgRelatedCachedVocabularies
from plonemeeting.core.utils import computeCertifiedSignatures
from plonemeeting.core.utils import listifySignatures
from plonemeeting.core.validators import DXCertifiedSignaturesValidator
...
class ICertifiedSignaturesRowSchema(Interface):
    ...
    held_position = schema.Choice(
        ...
        vocabulary='plonemeeting.core.vocabularies.every_heldpositions_vocabulary',
        required=False,
    )
...
class IPMOrganization(IOrganization):
    ...
    item_advice_states = schema.List(
        ...
        value_type=schema.Choice(
            vocabulary="plonemeeting.core.vocabularies.itemallstates"),
        required=False,
        default=[],
    )
