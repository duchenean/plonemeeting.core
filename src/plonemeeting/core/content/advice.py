...
from plonemeeting.core.utils import findMeetingAdvicePortalType
from plonemeeting.core.utils import get_event_field_data
from plonemeeting.core.utils import getAdvicePortalTypeIds
from plonemeeting.core.utils import getWorkflowAdapter
from plonemeeting.core.utils import historize_object_data
from plonemeeting.core.utils import isModifiedSinceLastVersion
...
class IMeetingAdvice(IDXMeetingContent):
    ...
    advice_group = LocalRoleField(
        ...
        vocabulary=u'plonemeeting.core.content.advice.advice_group_vocabulary',
        required=True,
    )
    ...
    advice_type = schema.Choice(
        ...
        vocabulary=u'plonemeeting.core.content.advice.advice_type_vocabulary',
        required=True,
    )
