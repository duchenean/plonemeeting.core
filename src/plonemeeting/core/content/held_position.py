...
from plonemeeting.core.events import _invalidateAttendeesRelatedCache
from plonemeeting.core.utils import _prefixed_gn_position_name
from plonemeeting.core.utils import plain_render
...
class IPMHeldPosition(IHeldPosition):
    ...
    usages = zope.schema.List(
        ...
        value_type=zope.schema.Choice(
            vocabulary="plonemeeting.core.vocabularies.pmheldposition_usagesvocabulary"),
        required=False,
        default=[],
    )
    ...
    defaults = zope.schema.List(
        title=_("Defaults"),
        value_type=zope.schema.Choice(
            vocabulary="plonemeeting.core.vocabularies.pmheldposition_defaultsvocabulary"),
        required=False,
        default=[],
    )
    ...
    signature_number = zope.schema.Choice(
        ...
        vocabulary="plonemeeting.core.vocabularies.numbersvocabulary",
        required=False,
    )
