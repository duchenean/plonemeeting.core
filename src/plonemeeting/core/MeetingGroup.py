...
class MeetingGroup(BaseContent, BrowserDefaultMixin):
    ...
    def _invalidateCachedVocabularies(self):
        ...
        invalidate_cachekey_volatile_for("plonemeeting.core.vocabularies.proposinggroupsvocabulary")
        invalidate_cachekey_volatile_for("plonemeeting.core.vocabularies.proposinggroupacronymsvocabulary")
        invalidate_cachekey_volatile_for("plonemeeting.core.vocabularies.proposinggroupsforfacetedfiltervocabulary")
        invalidate_cachekey_volatile_for("plonemeeting.core.vocabularies.groupsinchargevocabulary")
        invalidate_cachekey_volatile_for("plonemeeting.core.vocabularies.askedadvicesvocabulary")
