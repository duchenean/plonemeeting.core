...
class MeetingConfigDescriptor(Descriptor):
    ...
    def __init__(self, id, title, folderTitle, isDefault=False, active=True):
        ...
        self.itemConditionsInterface = \
            'plonemeeting.core.interfaces.IMeetingItemWorkflowConditions'
        self.itemActionsInterface = \
            'plonemeeting.core.interfaces.IMeetingItemWorkflowActions'
        self.meetingWorkflow = 'meeting_workflow'
        self.meetingConditionsInterface = \
            'plonemeeting.core.interfaces.IMeetingWorkflowConditions'
        self.meetingActionsInterface = \
            'plonemeeting.core.interfaces.IMeetingWorkflowActions'
