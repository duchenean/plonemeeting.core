    ...
    def _checkElementConfidentialAnnexAccess(self,
        ...
        for snake_name, vocab_name in (
            ('item_annex_confidential_visible_for',
             'plonemeeting.core.vocabularies.item_attribute_visible_for_vocabulary'),
            ('advice_annex_confidential_visible_for',
             'plonemeeting.core.vocabularies.advice_annex_confidential_visible_for_vocabulary'),
            ('meeting_annex_confidential_visible_for',
             'plonemeeting.core.vocabularies.meeting_annex_confidential_visible_for_vocabulary'),
        ):
