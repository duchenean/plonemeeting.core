...
from plonemeeting.core.indexes import indexAdvisers
...
class testAdvices(PloneMeetingTestCase):
    ...
    def test_pm_PowerAdvisers(self):
        ...
        factory = queryUtility(IVocabularyFactory, u'plonemeeting.core.content.advice.advice_group_vocabulary')
        vocab = factory(item)
        self.assertEqual(len(vocab), 1)
        self.assertTrue(self.vendors_uid in vocab)
    ...
    def test_pm_AvailableDelaysView(self):
        ...
        cleanRamCacheFor('plonemeeting.core.content.meetingconfig._findLinkedRowsFor')
    ...
    def test_pm_ChangeAdviceAskedAgainView(self):
        ...
        factory = queryUtility(
            IVocabularyFactory,
            u'plonemeeting.core.content.advice.advice_type_vocabulary')
    ...
    def test_pm_AdviceAccountingCommitmentBehavior(self):
        ...
        behaviors += ('plonemeeting.core.behaviors.advice.IAdviceAccountingCommitmentBehavior', )
