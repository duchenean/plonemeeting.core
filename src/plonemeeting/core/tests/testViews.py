...
from plonemeeting.core.etags import ConfigModified
from plonemeeting.core.etags import ContextModified
from plonemeeting.core.etags import LinkedMeetingModified
from plonemeeting.core.etags import ToolModified
from plonemeeting.core.ftw_labels.utils import get_labels
from plonemeeting.core.content.meetingitem import MeetingItem
from plonemeeting.core.tests.PloneMeetingTestCase import DEFAULT_USER_PASSWORD
from plonemeeting.core.tests.PloneMeetingTestCase import IMG_BASE64_DATA
...
from plonemeeting.core.utils import get_dx_widget
...
class testViews(PloneMeetingTestCase):
    ...
    def test_pm_MeetingStoreItemsPodTemplateAsAnnexBatchActionForm_may_store(self):
        ...
        self.assertEqual(
            get_vocab_values(
                cfg, 'plonemeeting.core.vocabularies.itemtemplatesstorableasannexvocabulary'),
            [])
    ...
    def test_pm_DocumentGenerationContext(self):
        ...
        from plonemeeting.core import utils
        from plonemeeting.core import safe_utils
