...
from plonemeeting.core.config import DEFAULT_USER_PASSWORD
...
from plonemeeting.core.testing import PM_TESTING_PROFILE_FUNCTIONAL
...
class PloneMeetingTestCase(unittest.TestCase, PloneMeetingTestingHelpers):
    ...
    def setUp(self):
        ...
        self.pmFolder = os.path.dirname(plonemeeting.core.__file__)
    ...
    def _enableField(self, field_names, cfg=None, related_to='MeetingItem', enable=True, reload=False):
        ...
        if reload:
            ...
            cleanRamCacheFor('plonemeeting.core.content.meeting.attribute_is_used')
