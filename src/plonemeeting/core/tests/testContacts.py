...
from plonemeeting.core.browser.itemattendee import _set_meeting_item_signatory
from plonemeeting.core.browser.itemattendee import WRONG_PERSON_UID
from plonemeeting.core.content.directory import IPMDirectory
...
from plonemeeting.core.content.source import PMContactSourceBinder
from plonemeeting.core.Extensions.imports import import_contacts
...
class testContacts(PloneMeetingTestCase):
    ...
    def test_pm_MayChangeAttendees(self):
        ...
        self.assertEqual(cm.exception.args[0], WRONG_PERSON_UID % wrong_uid)
    ...
    def test_pm_CanNotRemoveUsedOrganization(self):
        ...
        self.assertEqual(cm.exception.args[0], can_not_delete_organization_meetingconfig)
        ...
        can_not_delete_organization_plonegroup = \
            translate('can_not_delete_organization_plonegroup',
                      ...
                      domain="plone",
                      context=self.request)
        self.assertEqual(cm.exception.args[0], can_not_delete_organization_plonegroup)
        ...
        self.assertNotEqual(cm.exception.args[0], can_not_delete_organization_plonegroup)
        can_not_delete_organization_meetingitem = \
            translate('can_not_delete_organization_meetingitem',
                      ...
                      domain="plone",
                      context=self.request)
        self.assertEqual(cm.exception.args[0], can_not_delete_organization_meetingitem)
    ...
    def test_pm_DeactivatedOrgCanNoMoreBeUsed(self):
        ...
        advisers_vocab_factory = get_vocab(
            item,
            'plonemeeting.core.vocabularies.itemoptionaladvicesvocabulary',
            only_factory=True)
    ...
    def test_pm_ImportContactsCSV(self):
        ...
        path = os.path.join(os.path.dirname(plonemeeting.core.__file__), 'profiles/testing')
